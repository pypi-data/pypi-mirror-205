import{G as t,r as o,b as e,d as s,l as i,n as r,s as n,y as a}from"./index-f2af38a5.js";import"./c.419250e6.js";import"./c.13f7e761.js";import{g as c}from"./c.63fcbfd6.js";import{m as l,s as p,b as m}from"./c.32c39114.js";const h=(t,o)=>{import("./c.d3acb8dc.js");const e=document.createElement("esphome-logs-dialog");e.configuration=t,e.target=o,document.body.append(e)},d=(t,o,e)=>{import("./c.09c62faa.js");const s=document.createElement("esphome-logs-webserial-dialog");s.configuration=e,s.port=t,s.closePortOnClose=o,document.body.append(s)};let w=class extends n{constructor(){super(...arguments),this._show="options"}render(){let t,o;return"options"===this._show?(t="How to get the logs for your device?",o=a`
        <mwc-list-item
          twoline
          hasMeta
          dialogAction="close"
