import{e as t,c as e,I as o,J as i,r as s,b as r,d as a,n,s as l,y as c,f as d,K as p,L as h,N as m,O as u,G as w,l as _,P as v,D as g,Q as y}from"./index-f2af38a5.js";import{g as f}from"./c.63fcbfd6.js";import"./c.419250e6.js";import{o as b,c as $}from"./c.33591792.js";import{m as P,s as S,b as k}from"./c.32c39114.js";import{o as x}from"./c.f7445c67.js";class C{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class E{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){var t;null!==(t=this.Z)&&void 0!==t||(this.Z=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Z=this.q=void 0}}const H=t=>!i(t)&&"function"==typeof t.then;const W=t(class extends e{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CK=new C(this),this._$CX=new E}render(...t){var e;return null!==(e=t.find((t=>!H(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const r=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const o=e[t];if(!H(o))return this._$Cwt=t,o;t<s&&o===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cyt.indexOf(o);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),j=(t,e)=>{import("./c.fc1c6728.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.downloadFactoryFirmware=e,document.body.append(o)},I=async(t,e)=>{import("./c.005c09ab.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?b((()=>I(t,e))):alert(`Unable to connect: ${o.message}`))}const i=$(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},A={info:p,warning:h,error:m,success:u};let T=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return c`
  ...
  `,r([a()],T.prototype,"title",void 0),r([a({attribute:"alert-type"})],T.prototype,"alertType",void 0),r([a({type:Boolean})],T.prototype,"rtl",void 0),T=r([n("esphome-alert")],T);let D=class extends l{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=c`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
    ...
    `],r([a()],D.prototype,"configuration",void 0),r([_()],D.prototype,"_ethernet",void 0),r([_()],D.prototype,"_isPico",void 0),r([_()],D.prototype,"_ports",void 0),r([_()],D.prototype,"_state",void 0),r([_()],D.prototype,"_error",void 0),D=r([n("esphome-install-choose-dialog")],D);var B=Object.freeze({__proto__:null});export{I as a,B as i,j as o};
