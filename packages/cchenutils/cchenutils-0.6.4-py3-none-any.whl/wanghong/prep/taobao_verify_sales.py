...
if __name__ == '__main__':
    ...
    df_items = pd.read_csv(f'{DATA_DIR}/_taobao_items.csv', usecols=['_id', 'sales'], dtype={'_id': str}) \
    ...
    b = (df_30sales['rates_bjt_adj'] - df_30sales['sales']).apply(lambda x: math.log(abs(x)+1))
