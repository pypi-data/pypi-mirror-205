...
TreeSAK VisHPD95 -i VisHPD95.txt -o VisHPD95.pdf
TreeSAK VisHPD95 -i VisHPD95.txt -o VisHPD95.pdf -x 9 -y 6

# Example data
https://github.com/songweizhi/TreeSAK/tree/master/example_data/VisHPD95

# Note!!!
# Do NOT change the header of VisHPD95.txt
...
def VisHPD95(args):
    ...
    for mcmc_out_file in mcmc_out_file_list:
        ...
        label_to_write = label_dict.get(mcmc_out_file_no_path, mcmc_out_file_no_path)
        ...
        for each_node in node_set:
            ...
            dm_out_handle.write('%s\t%s\t%s\n' % (label_to_write, node_name_to_write, '\t'.join(mean_95_hpd_list)))
    dm_out_handle.close()

    VisHPD95_R = '/Users/songweizhi/PycharmProjects/TreeSAK/TreeSAK/VisHPD95.R'
...
/Users/songweizhi/Desktop/777
python3 ~/PycharmProjects/TreeSAK/TreeSAK/VisHPD95.py -i M1_mcmc_txt -o M1_HPD95.pdf -n nodes_Eu.txt
