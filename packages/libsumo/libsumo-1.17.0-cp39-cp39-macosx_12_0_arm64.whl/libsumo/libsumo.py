...
class TraCIJunctionFoeVector(object):
    ...
    def __init__(self, *args):
        _libsumo.TraCIJunctionFoeVector_swiginit(self, _libsumo.new_TraCIJunctionFoeVector(*args))
...
# Register TraCIJunctionFoeVector in _libsumo:
_libsumo.TraCIJunctionFoeVector_swigregister(TraCIJunctionFoeVector)
