...
class TraCIJunctionFoeVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        _libtraci.TraCIJunctionFoeVector_swiginit(self, _libtraci.new_TraCIJunctionFoeVector(*args))
...
# Register TraCIJunctionFoeVector in _libtraci:
_libtraci.TraCIJunctionFoeVector_swigregister(TraCIJunctionFoeVector)
...
class inductionloop(object):
    ...
    @staticmethod
    def getIntervalVehicleIDs(detID):
    ...
    @staticmethod
    def getLastIntervalVehicleIDs(detID):
        return _libtraci.inductionloop_getLastIntervalVehicleIDs(detID)

    @staticmethod
    def overrideTimeSinceDetection(detID, time):
...
class lanearea(object):
    ...
    @staticmethod
    def overrideVehicleNumber(detID, num):
...
class vehicle(object):
    ...
    @staticmethod
    def getStopParameter(vehID, nextStopIndex, param):
    ...
    @staticmethod
    def setStopParameter(vehID, nextStopIndex, param, value):
    ...
    @staticmethod
    def setAcceleration(vehID, accel, duration):
