...
class EBMPreprocessor(BaseEstimator, TransformerMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            feature_types: Feature types as list, for example "numerical" or "categorical".
...
class BaseEBM(BaseEstimator):
    ...
    def __init__(
        ...
        #   feature_types = ["categorical", ["low", "medium", "high"], "numerical", "time", "bool"]
        feature_types,
        # Data
        #
        # Ensemble
    ...
    def fit(self, X, y, sample_weight=None, feature_names=None, feature_types=None):  # noqa: C901
