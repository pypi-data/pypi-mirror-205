...
class Density:
    ...
    max_float = 5, mol_select = None, start = None, end = None,  _dir_ = 'Z', imcon = None, nsit = None, angle = None,
    z_first_layer = None, delta = 0.0, CELL = None, r_step = 0.1, replicated_layer = False, limit_box = 0., charge = None,
    scaler = None, Normalize = False, Name_cal = 'AtomicDensity', atoms_name = None, rho_0 = None):
        ...
        if not z_first_layer :
            ...
            if type(z_first_layer) == type(t1):
                if len(z_first_layer) != 2:
                    ...
                    def print_error():
                        print('ErrorValue 😊')
                        print("z_first_layer is a list with a length agal 2")
                        print('z_first_layer, ',type(t1))
                        print('[a, b]')
                ...
                def print_error():
                    print('ErrorType 😊')
                    print("z_first_layer type not in the list : ", [type(t1), type(t2)])
                    print('Making your choice in the list above and try again')
                exit()
        ...
        if type(Name_cal) != type(t5):
            @decor
            def print_error():
                print('ErrorType 😊')
                print('Name_cal is a string type not any other type')
                print('Name_cal, ',type(t5))
                print("Put a string type and run again")
            exit()
        
        if type(replicated_layer) != type(t4):
            @decor
            def print_error():
                print('ErrorType 😊')
                print('replicated_layer is a boolean type not any other type')
                print('replicated_layer, ',type(t4))
                print('Put a boolean type and run again')
            exit()

        if type(Normalize) != type(t4):
            @decor
            def print_error():
                print('ErrorType 😊')
                print('Normalize is a boolean type not any other type')
                print('Normalize, ',type(t4))
                print('Put a boolean type and run again')
            exit()

        if type(_dir_) != type(t5):
            @decor
            def print_error():
                print('ErrorType 😊')
                print('_dir_ is a string type not any other type')
                print('_dir_, ',type(t5))
                print('put _dir_ as a string and run again')
            exit()

        if type(limit_box) != type(t2):
            @decor 
            def print_error():
                print('ErrorType 😊')
                print('limit_box is a float not any other type')
                print('limit_box, ',type(t2))
                print('Put imit_box as a float and run again')
            exit()

        if type(r_step) != type(t2):
            @decor 
            def print_error():
                print('ErrorType 😊')
                print('r_step is a float not any other type')
                print('r_step, ',type(t2))
                print('Put r_step as a float and run again')
            exit()

        if type(scaler) not in [None, type(t5)]:
            @decor 
            def print_error():
                print('ErrorType 😊')
                print('scaler is not in the list : ', [None, type(t5)])
                print('Making a choice in the list above and try again')
            exit()
        ...
        volume = Volume(CELL=CELL, imcon=imcon, angle = angle)
            ...
            for t in range(start, end):
                for i in index_density_com:  
                    for j in range(0, nmol[i]):
                        ...
                        #dat1 = Parallel(n_jobs=num_cores)(delayed(ProcessInput)(k) for k in range(0, 1))
