...
# это пиздец полный
for i in (AccountAccountCounters, AccountInfo, AccountNameRequest, AccountNameRequestStatus, AccountOffer, AccountPushConversations,
          AccountPushConversationsItem, AccountPushParams, AccountPushParamsMode, AccountPushParamsOnoff, AccountPushParamsSettings,
          AccountPushSettings, AccountSubscriptions, AccountUserSettings, AccountUserSettingsInterest, AccountUserSettingsInterests, AddressesFields,
          AdsAccessRole, AdsAccessRolePublic, AdsAccesses, AdsAccount, AdsAccountType, AdsAd, AdsAdApproved, AdsAdCostType, AdsAdLayout, AdsAdStatus,
          AdsCampaign, AdsCampaignStatus, AdsCampaignType, AdsCategory, AdsClient, AdsCreateAdStatus, AdsCreateCampaignStatus, AdsCriteria,
          AdsCriteriaSex, AdsDemoStats, AdsDemostatsFormat, AdsFloodStats, AdsLinkStatus, AdsLookalikeRequest, AdsLookalikeRequestSaveAudienceLevel,
          AdsMusician, AdsObjectType, AdsParagraphs, AdsPromotedPostReach, AdsRejectReason, AdsRules, AdsStats, AdsStatsAge, AdsStatsCities,
          AdsStatsFormat, AdsStatsSex, AdsStatsSexAge, AdsStatsSexValue, AdsStatsViewsTimes, AdsTargSettings, AdsTargStats, AdsTargSuggestions,
          AdsTargSuggestionsCities, AdsTargSuggestionsRegions, AdsTargSuggestionsSchools, AdsTargSuggestionsSchoolsType, AdsTargetGroup,
          AdsUpdateOfficeUsersResult, AdsUserSpecification, AdsUserSpecificationCutted, AdsUsers, AdswebGetAdCategoriesResponseCategoriesCategory,
          AdswebGetAdUnitsResponseAdUnitsAdUnit, AdswebGetFraudHistoryResponseEntriesEntry, AdswebGetSitesResponseSitesSite,
          AdswebGetStatisticsResponseItemsItem, AppWidgetsPhoto, AppWidgetsPhotos, AppsApp, AppsAppLeaderboardType, AppsAppMin, AppsAppType,
          AppsCatalogList, AppsLeaderboard, AppsScope, AudioAudio, BaseCity, BaseCommentsInfo, BaseCountry, BaseCropPhoto, BaseCropPhotoCrop,
          BaseCropPhotoRect, BaseError, BaseGeo, BaseGeoCoordinates, BaseGradientPoint, BaseImage, BaseLikes, BaseLikesInfo, BaseLink,
          BaseLinkApplication, BaseLinkApplicationStore, BaseLinkButton, BaseLinkButtonAction, BaseLinkButtonActionType, BaseLinkButtonStyle,
          BaseLinkProduct, BaseLinkProductCategory, BaseLinkProductStatus, BaseLinkRating, BaseMessageError, BaseObject, BaseObjectCount,
          BaseObjectWithName, BasePlace, BasePropertyExists, BaseRepostsInfo, BaseRequestParam, BaseSex, BaseSticker, BaseStickerAnimation,
          BaseStickerNew, BaseStickerOld, BaseStickersList, BaseUploadServer, BaseUserGroupFields, BaseUserId, BoardDefaultOrder, BoardTopic,
          BoardTopicComment, CallbackBase, CallbackBoardPostDelete, CallbackConfirmation, CallbackDonutMoneyWithdraw, CallbackDonutMoneyWithdrawError,
          CallbackDonutSubscriptionCancelled, CallbackDonutSubscriptionCreate, CallbackDonutSubscriptionExpired,
          CallbackDonutSubscriptionPriceChanged, CallbackDonutSubscriptionProlonged, CallbackGroupChangePhoto, CallbackGroupChangeSettings,
          CallbackGroupJoin, CallbackGroupJoinType, CallbackGroupLeave, CallbackGroupMarket, CallbackGroupOfficerRole, CallbackGroupOfficersEdit,
          CallbackGroupSettingsChanges, CallbackLikeAddRemove, CallbackMarketComment, CallbackMarketCommentDelete, CallbackMessageAllow,
          CallbackMessageAllowObject, CallbackMessageDeny, CallbackMessageEdit, CallbackMessageNew, CallbackMessageObject, CallbackMessageReply,
          CallbackPhotoComment, CallbackPhotoCommentDelete, CallbackPollVoteNew, CallbackQrScan, CallbackType, CallbackUserBlock, CallbackUserUnblock,
          CallbackVideoComment, CallbackVideoCommentDelete, CallbackWallCommentDelete, CallsCall, CallsEndState, CallsParticipants, ClientInfoForBots,
          CommentThread, DatabaseCity, DatabaseCityById, DatabaseFaculty, DatabaseRegion, DatabaseSchool, DatabaseStation, DatabaseUniversity,
          DocsDoc, DocsDocAttachmentType, DocsDocPreview, DocsDocPreviewAudioMsg, DocsDocPreviewGraffiti, DocsDocPreviewPhoto,
          DocsDocPreviewPhotoSizes, DocsDocPreviewVideo, DocsDocTypes, DonutDonatorSubscriptionInfo, EventsEventAttach, FaveBookmark,
          FaveBookmarkType, FavePage, FavePageType, FaveTag, FriendsFriendExtendedStatus, FriendsFriendStatus, FriendsFriendStatusStatus,
          FriendsFriendsList, FriendsMutualFriend, FriendsRequests, FriendsRequestsMutual, FriendsRequestsXtrMessage, FriendsUserXtrPhone, GiftsGift,
          GiftsGiftPrivacy, GiftsLayout, GroupsAddress, GroupsAddressTimetable, GroupsAddressTimetableDay, GroupsAddressWorkInfoStatus,
          GroupsAddressesInfo, GroupsBanInfo, GroupsBanInfoReason, GroupsBannedItem, GroupsCallbackServer, GroupsCallbackSettings, GroupsContactsItem,
          GroupsCountersGroup, GroupsCover, GroupsFields, GroupsFilter, GroupsGroup, GroupsGroupAccess, GroupsGroupAdminLevel, GroupsGroupAgeLimits,
          GroupsGroupAttach, GroupsGroupAudio, GroupsGroupBanInfo, GroupsGroupCategory, GroupsGroupCategoryFull, GroupsGroupCategoryType,
          GroupsGroupDocs, GroupsGroupFull, GroupsGroupFullAgeLimits, GroupsGroupFullMemberStatus, GroupsGroupFullSection, GroupsGroupIsClosed,
          GroupsGroupMarketCurrency, GroupsGroupPhotos, GroupsGroupPublicCategoryList, GroupsGroupRole, GroupsGroupSubject,
          GroupsGroupSuggestedPrivacy, GroupsGroupTag, GroupsGroupTopics, GroupsGroupType, GroupsGroupVideo, GroupsGroupWall, GroupsGroupWiki,
          GroupsGroupsArray, GroupsLinksItem, GroupsLiveCovers, GroupsLongPollEvents, GroupsLongPollServer, GroupsLongPollSettings, GroupsMarketInfo,
          GroupsMarketState, GroupsMemberRole, GroupsMemberRolePermission, GroupsMemberRoleStatus, GroupsMemberStatus, GroupsMemberStatusFull,
          GroupsOnlineStatus, GroupsOnlineStatusType, GroupsOwnerXtrBanInfo, GroupsOwnerXtrBanInfoType, GroupsPhotoSize, GroupsRoleOptions,
          GroupsSectionsListItem, GroupsSettingsTwitter, GroupsSubjectItem, GroupsTokenPermissionSetting, GroupsUserXtrRole, LeadFormsAnswer,
          ...
          MarketServicesViewType, MessagesAudioMessage, MessagesChat, MessagesChatFull, MessagesChatPreview, MessagesChatPushSettings,
          MessagesChatRestrictions, MessagesChatSettings, MessagesChatSettingsAcl, MessagesChatSettingsPermissions, MessagesChatSettingsPhoto,
          MessagesChatSettingsState, MessagesConversation, MessagesConversationCanWrite, MessagesConversationMember, MessagesConversationPeer,
          MessagesConversationPeerType, MessagesConversationSortId, MessagesConversationWithMessage, MessagesForeignMessage, MessagesForward,
          MessagesGetConversationById, MessagesGetConversationByIdExtended, MessagesGetConversationMembers, MessagesGraffiti,
          MessagesHistoryAttachment, MessagesHistoryMessageAttachment, MessagesHistoryMessageAttachmentType, MessagesKeyboard, MessagesKeyboardButton,
MessagesKeyboardButtonActionCallback, MessagesKeyboardButtonActionLocation, MessagesKeyboardButtonActionOpenApp, MessagesKeyboardButtonActionOpenLink,
MessagesKeyboardButtonActionOpenPhoto, MessagesKeyboardButtonActionText, MessagesKeyboardButtonActionVkpay, MessagesKeyboardButtonPropertyAction,
MessagesLastActivity, MessagesLongpollMessages, MessagesLongpollParams, MessagesMessage, MessagesMessageAction, MessagesMessageActionPhoto,
MessagesMessageActionStatus, MessagesMessageAttachment, MessagesMessageAttachmentType, MessagesMessageRequestData, MessagesMessagesArray,
MessagesOutReadBy, MessagesPinnedMessage, MessagesPushSettings, MessagesSendUserIdsResponseItem, MessagesTemplateActionTypeNames,
MessagesUserXtrInvitedBy, NewsfeedCommentsFilters, NewsfeedIgnoreItemType, NewsfeedItemAudio, NewsfeedItemAudioAudio, NewsfeedItemBase,
NewsfeedItemDigest, NewsfeedItemDigestButton, NewsfeedItemDigestFooter, NewsfeedItemDigestFullItem, NewsfeedItemDigestHeader, NewsfeedItemDigestItem,
NewsfeedItemFriend, NewsfeedItemFriendFriends, NewsfeedItemHolidayRecommendationsBlockHeader, NewsfeedItemPhoto, NewsfeedItemPhotoPhotos,
NewsfeedItemPhotoTag, NewsfeedItemPhotoTagPhotoTags, NewsfeedItemPromoButton, NewsfeedItemPromoButtonAction, NewsfeedItemPromoButtonImage,
NewsfeedItemTopic, NewsfeedItemVideo, NewsfeedItemVideoVideo, NewsfeedItemWallpost, NewsfeedItemWallpostFeedback, NewsfeedItemWallpostFeedbackAnswer,
NewsfeedItemWallpostFeedbackType, NewsfeedList, NewsfeedListFull, NewsfeedNewsfeedItem, NewsfeedNewsfeedItemType, NewsfeedNewsfeedPhoto, NotesNote,
NotesNoteComment, NotificationsFeedback, NotificationsNotification, NotificationsNotificationItem, NotificationsNotificationParent,
NotificationsNotificationsComment, NotificationsReply, NotificationsSendMessageError, NotificationsSendMessageItem, OauthError, OrdersAmount,
OrdersAmountItem, OrdersOrder, OrdersSubscription, OwnerState, PagesPrivacySettings, PagesWikipage, PagesWikipageFull, PagesWikipageHistory,
PhotosImage, PhotosImageType, PhotosPhoto, PhotosPhotoAlbum, PhotosPhotoAlbumFull, PhotosPhotoFalseable, PhotosPhotoFullXtrRealOffset,
PhotosPhotoSizes, PhotosPhotoSizesType, PhotosPhotoTag, PhotosPhotoUpload, PhotosPhotoXtrRealOffset, PhotosPhotoXtrTagInfo, PhotosTagsSuggestionItem,
PhotosTagsSuggestionItemButton, PodcastCover, PodcastExternalData, PollsAnswer, PollsBackground, PollsFriend, PollsPoll, PollsPollAnonymous,
PollsVoters, PollsVotersUsers, PrettyCardsPrettyCard, PrettyCardsPrettyCardOrError, SearchHint, SearchHintSection, SearchHintType,
SecureGiveEventStickerItem, SecureLevel, SecureSetCounterItem, SecureSmsNotification, SecureTokenChecked, SecureTransaction, StatsActivity, StatsCity,
StatsCountry, StatsPeriod, StatsReach, StatsSexAge, StatsViews, StatsWallpostStat, StatusStatus, StickersImageSet, StorageValue, StoreProduct,
StoreProductIcon, StoreStickersKeyword, StoreStickersKeywordSticker, StoreStickersKeywordStickers, StoriesClickableArea, StoriesClickableSticker,
StoriesClickableStickers, StoriesFeedItem, StoriesPromoBlock, StoriesReplies, StoriesStatLine, StoriesStory, StoriesStoryLink, StoriesStoryStats,
StoriesStoryStatsStat, StoriesStoryStatsState, StoriesStoryType, StoriesUploadLinkText, StoriesViewersItem, UsersCareer, UsersExports, UsersFields,
UsersLastSeen, UsersMilitary, UsersOccupation, UsersOnlineInfo, UsersPersonal, UsersRelative, UsersSchool, UsersSubscriptionsItem, UsersUniversity,
UsersUser, UsersUserConnections, UsersUserCounters, UsersUserFull, UsersUserMin, UsersUserRelation, UsersUserSettingsXtr, UsersUserType,
UsersUserXtrType, UsersUsersArray, UtilsDomainResolved, UtilsDomainResolvedType, UtilsLastShortenedLink, UtilsLinkChecked, UtilsLinkCheckedStatus,
UtilsLinkStats, UtilsLinkStatsExtended, UtilsShortLink, UtilsStats, UtilsStatsCity, UtilsStatsCountry, UtilsStatsExtended, UtilsStatsSexAge,
VideoLiveInfo, VideoLiveSettings, VideoSaveResult, VideoVideo, VideoVideoAlbum, VideoVideoAlbumFull, VideoVideoFiles, VideoVideoFull, VideoVideoImage,
WallAppPost, WallAttachedNote, WallCarouselBase, WallCommentAttachment, WallCommentAttachmentType, WallGeo, WallGetFilter, WallGraffiti,
WallPostCopyright, WallPostSource, WallPostSourceType, WallPostType, WallPostedPhoto, WallViews, WallWallComment, WallWallCommentDonut,
WallWallCommentDonutPlaceholder, WallWallpost, WallWallpostAttachment, WallWallpostAttachmentType, WallWallpostCommentsDonut,
WallWallpostCommentsDonutPlaceholder, WallWallpostDonut, WallWallpostDonutPlaceholder, WallWallpostFull, WallWallpostToId, WidgetsCommentMedia,
WidgetsCommentMediaType, WidgetsCommentReplies, WidgetsCommentRepliesItem, WidgetsWidgetComment, WidgetsWidgetLikes, WidgetsWidgetPage):
    if issubclass(i,BM):
