...
if (x_range.start<loaded_glyph_source.data.start+2000 || x_range.end>loaded_glyph_source.data.end-2000){
    ...
    const max_glyph_loading_range=loaded_glyph_source.data['range'][0]
    ...
    loaded_glyph_source.data['start'] = all_glyphs['xs'][ix_start][0];
    loaded_glyph_source.data['end'] = all_glyphs['xs'][ix_stop][3];
