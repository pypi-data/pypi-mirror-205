...
+'.. note::\n    As the plotting is generated by the use of the tentatively developed "matplotlib.gridspec" module some '\
...
+'x and y coordinate axis perpendicular. Not everything is completely trivial as the hover-over tool tip becomes dependent on the plane chosen. This is '\
+'dealt with by introducing a step corresponding to the plane. This is then taken into account when calculating the correct H, K, L, and energy position.'
