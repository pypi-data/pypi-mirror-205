...
def test_ConditionEnvironment():
    ...
    from qrisp import QuantumChar, QuantumFloat, QuantumBool, QuantumVariable, h, x, cx, mcx, p, multi_measurement, ConditionEnvironment
    import numpy as np
    ...
    assert multi_measurement([q_bool_0, q_bool_1, q_bool_2]) == {(False, False, True): 0.5, (True, False, False): 0.5}
...
def test_InversionEnvironment():
    ...
    assert multi_measurement([qf, q_bool]) == {(0, True): 0.125, (1, True): 0.125, (2, True): 0.125, (3, True): 0.125, (4, False): 0.125, (5, False): 0.125, (6, False): 0.125, (7, False): 0.125}
