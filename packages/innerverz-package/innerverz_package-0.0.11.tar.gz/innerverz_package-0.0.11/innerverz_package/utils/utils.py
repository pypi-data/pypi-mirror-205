...
def set_dir(assets_path, save_path):
    os.makedirs(os.path.join(assets_path, 'full_frames'), exist_ok=True)
    os.makedirs(os.path.join(assets_path, 'face'), exist_ok=True)
    os.makedirs(os.path.join(assets_path, 'label'), exist_ok=True)
    os.makedirs(os.path.join(assets_path, 'bg_mask'), exist_ok=True)
    os.makedirs(os.path.join(assets_path, 'bg_head_mask'), exist_ok=True)
    
    if save_path != None:
        os.makedirs(os.path.join(assets_path, 'SR'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'Color_Transfer'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'Color_map'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'head_mask'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'innerface_mask'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'full_result'), exist_ok=True)
        os.makedirs(os.path.join(save_path, 'relight_faces'), exist_ok=True)
