...
First, you might want to upgrade your environment's basic libraries:
...
To install it with extensions (e.g. here Google and Science):

```bash
pip install "bbc-dslib[google,science]"
```
...
```bash
git clone ssh://git@github.com:blablacar/data-dslib.git
pip install -e "./data-dslib/[google,science]"
```
...
```bash
pip install -e "./dslib/[google,science]"
```
