...
from contrast.extern.ruamel.yaml.compat import (_F, builtins_module, # NOQA
                                nprint, nprintf, version_tnf)
from contrast.extern.ruamel.yaml.compat import ordereddict
...
from contrast.extern.ruamel.yaml.util import timestamp_regexp, create_timestamp
