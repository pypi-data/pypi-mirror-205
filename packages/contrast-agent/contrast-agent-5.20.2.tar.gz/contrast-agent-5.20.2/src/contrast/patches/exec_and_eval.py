...
from contrast.patches.rewriter import populate_rewritten_functions
...
def rewrite(mode, code):
    ...
    from contrast.agent.rewriter import PropagationRewriter

    rewriter = PropagationRewriter.with_default_settings(override_check=True)
...
def build_exec_eval_patch(orig_func, _, rule_applicator, mode):
    def exec_eval_patch(code, globs=None, locs=None):
        ...
        populate_rewritten_functions(globs)
