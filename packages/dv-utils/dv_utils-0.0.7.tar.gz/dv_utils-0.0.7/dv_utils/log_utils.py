...
def audit_log(app_id:str|None, log:str|None=None, data:dict|None=None, app="operator", **extra_labels):
...
async def audit_log_async(app_id:str|None, log:str|None=None, data:dict|None=None, app="operator", **extra_labels):
    app_namespace, data = prepare_log(app_id=app_id, log=log, data=data, app=app, **extra_labels)
    if(app_namespace):
