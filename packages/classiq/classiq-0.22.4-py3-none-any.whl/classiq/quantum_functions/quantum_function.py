...
class QuantumFunction:
    def __init__(self) -> None:
        self._function_data: Optional[ForeignFunctionDefinition] = None
    ...
    def add_implementation(
        ...
        if self._function_data is None:
            self._function_data = ForeignFunctionDefinition(
                name=func_name,
    ...
    def function_data(self, new_function_data: ForeignFunctionDefinition) -> None:
