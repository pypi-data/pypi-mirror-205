...
class JupyterSocialHandler(JupyterHandler):
    """JupyterSocialHandler"""
    ...
    def get(self):
        self.finish(json.dumps({
            "data": "This is /jupyter_social/get_example endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_social", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_social", "echo")
    handlers = [
        (route_pattern, JupyterSocialHandler),
