...
which rustup > /dev/null || curl --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- -y --profile minimal --default-toolchain 1.67
...
echo "::endgroup::"
maturin build --release --out target/wheels/ -i python3.9 --universal2