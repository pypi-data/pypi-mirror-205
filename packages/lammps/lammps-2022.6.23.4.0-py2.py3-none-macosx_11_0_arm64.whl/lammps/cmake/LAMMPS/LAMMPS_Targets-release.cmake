...
set_target_properties(LAMMPS::lammps PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./liblammps.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liblammps.0.dylib"
  )

list(APPEND _cmake_import_check_targets LAMMPS::lammps )
list(APPEND _cmake_import_check_files_for_LAMMPS::lammps "${_IMPORT_PREFIX}/./liblammps.0.dylib" )
