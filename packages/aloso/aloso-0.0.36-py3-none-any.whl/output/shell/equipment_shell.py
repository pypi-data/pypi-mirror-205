...
class EquipmentShell(Equipments):
            ...
            for section in config_.sections():
                for variable in config_[section]:
                    if variable.__contains__(config.separateur):
                        ...
                        # TODO: Fake versions
                        equipment.version = EquipmentShell.get_equipment_version()
    ...
    def get_most_recent_file_info(directory_path: str, connection: ftplib.FTP) -> dict[str, any]:
        ...
        try:
            ...
            logging.info(f'Information date fichier FTP : {connection.sendcmd("MDTM " + recent_file)}')
            print(f'Information date fichier FTP : {connection.sendcmd("MDTM " + recent_file)}')
        except Exception as e:
    ...
    @staticmethod
    def get_equipment_version(command: str = None):
        try:
    ...
    def get_all_equipments_versions(command: list):
        for _ in command:
            yield EquipmentShell.get_equipment_version()
