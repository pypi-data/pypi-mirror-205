...
class Command(sqlalchemy.db.Model, Table):
    ...
    @classmethod
    def queued_commands(cls, service_id: str = None, server_name: str = None) -> list[Command | Table]:
        params = {}
        if service_id:
    ...
    @classmethod
    def completed_commands(cls, service_id: str = None, server_name: str = None) -> list[Command | Table]:
        params = {}
        if service_id:
            params['service_id'] = service_id
        if server_name:
