...
class Command(sqlalchemy.db.Model, Table):
    ...
    @classmethod
    def queued_commands(cls, admin_gamertag: str = None, player_gamertag: str = None, service_id: str = None, server_name: str = None) -> list[Command | Table]:
        params = {}
        if service_id:
    ...
    @classmethod
    def completed_commands(cls, admin_gamertag: str = None, player_gamertag: str = None, service_id: str = None, server_name: str = None) -> list[Command | Table]:
        params = {}
        if service_id:
            params['service_id'] = service_id
        if server_name:
    ...
    @classmethod
    def player_commands(cls, gamertag: str) -> list[Command | Table]:
        return cls.find_all_by(player_gamertag=gamertag)

    @classmethod
    def admin_commands(cls, gamertag: str) -> list[Command | Table]:
    ...
    def __init__(
        ...
        self.executed_at = executed and not executed_at and datetime.now() or executed_at
