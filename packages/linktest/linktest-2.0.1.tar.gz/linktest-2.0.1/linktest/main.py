...
# linktest/main.py
"""
linktest is an automation test framework developed using python3 + selenium + appium, which supports the automation of API & UI & Mobile.
What can linktest do?
    ...
    - support save execution logs into testdb, should work with linktest-dashboard (show the execution_logs summary & details & histories)
...
to use linktest framework, your project must has 2 configuration files(will be auto generated if not exists):
    1. settings/__init__.py is used to configure below items for the linktest
        ...
        - SAVE_LOG_TO_DB = False (save execution logs into testdb, should work with linktest-dashboard)
...
Usage of linktest automation framework:
    1.run CMD: "pip install linktest" to install.
    ...
    ------ API Testcase demo ------:
        ...
        class Testcase1(APITestCase):
            ...
            def run_test(self):
                ...
                self.GlobalObjData["username"] = "linktest"
    ...
    ------ Define Multiple Testcase Classes In One Module ------:
        '''
        linktest support to define multiple Testcase Classes in one module here define 3 testcases(Class Names) in module: testcase_demo.py
        '''
        from settings.testcase_tags import Tags
