...
class EgressDevice(object):
    ...
    def __init__(self, id=None, label=None, name=None, method=None, api_keys=None, key=None, type=None, version=None, errors=None, info=None, interval=None, last_seen=None, disabled=None, deleted=None, storage_config=None, modified=None):  # noqa: E501
