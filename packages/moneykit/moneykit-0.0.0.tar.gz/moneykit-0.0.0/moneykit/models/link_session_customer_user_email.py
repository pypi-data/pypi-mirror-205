...
class LinkSessionCustomerUserEmail(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkSessionCustomerUserEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkSessionCustomerUserEmail:
        """Create an instance of LinkSessionCustomerUserEmail from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LinkSessionCustomerUserEmail.parse_obj(obj)

        _obj = LinkSessionCustomerUserEmail.parse_obj(
