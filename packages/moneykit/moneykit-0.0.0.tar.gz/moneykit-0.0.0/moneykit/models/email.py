...
class Email(BaseModel):
    ...
    primary: Optional[StrictBool] = Field(
        False, description="Indicates if this is the primary email address for the account owner."
    )
    __properties = ["address", "primary"]
    ...
    def from_dict(cls, obj: dict) -> Email:
        ...
        _obj = Email.parse_obj(
            {"address": obj.get("address"), "primary": obj.get("primary") if obj.get("primary") is not None else False}
        )
        return _obj
