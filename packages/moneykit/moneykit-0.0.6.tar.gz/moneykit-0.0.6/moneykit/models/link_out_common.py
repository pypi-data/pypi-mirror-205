...
class LinkOutCommon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkOutCommon:
        """Create an instance of LinkOutCommon from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkOutCommon:
        """Create an instance of LinkOutCommon from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LinkOutCommon.parse_obj(obj)

        _obj = LinkOutCommon.parse_obj(
            {
