...
class LinkSessionCustomerUserPhone(BaseModel):
    ...
    number: constr(strict=True, max_length=250, min_length=4) = Field(
    ...
    __properties = ["number", "country", "customer_verified_at"]

    @validator("number")
    def number_validate_regular_expression(cls, v):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkSessionCustomerUserPhone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkSessionCustomerUserPhone:
        """Create an instance of LinkSessionCustomerUserPhone from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LinkSessionCustomerUserPhone.parse_obj(obj)

        _obj = LinkSessionCustomerUserPhone.parse_obj(
            {
