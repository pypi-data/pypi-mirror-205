...
class Link3(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Link3:
        """Create an instance of Link3 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Link3:
        """Create an instance of Link3 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Link3.parse_obj(obj)

        _obj = Link3.parse_obj(
            {
