...
class Link2(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Link2:
        """Create an instance of Link2 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Link2:
        """Create an instance of Link2 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Link2.parse_obj(obj)

        _obj = Link2.parse_obj(
            {
