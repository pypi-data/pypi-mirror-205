...
class Link4(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Link4:
        """Create an instance of Link4 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Link4:
        """Create an instance of Link4 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Link4.parse_obj(obj)

        _obj = Link4.parse_obj(
            {
