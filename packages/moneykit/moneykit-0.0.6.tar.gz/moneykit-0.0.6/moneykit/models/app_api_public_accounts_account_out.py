...
class AppApiPublicAccountsAccountOut(BaseModel):
    """
    AppApiPublicAccountsAccountOut
    """
    ...
    balances: Balances = ...
    __properties = ["account_id", "account_type", "name", "account_mask", "balances"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppApiPublicAccountsAccountOut:
        """Create an instance of AppApiPublicAccountsAccountOut from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppApiPublicAccountsAccountOut:
        """Create an instance of AppApiPublicAccountsAccountOut from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AppApiPublicAccountsAccountOut.parse_obj(obj)

        _obj = AppApiPublicAccountsAccountOut.parse_obj(
            {
