...
class IdentityLinkProduct(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityLinkProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityLinkProduct:
        """Create an instance of IdentityLinkProduct from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IdentityLinkProduct.parse_obj(obj)

        _obj = IdentityLinkProduct.parse_obj(
            {
