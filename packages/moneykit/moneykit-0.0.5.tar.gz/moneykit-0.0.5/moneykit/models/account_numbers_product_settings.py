...
class AccountNumbersProductSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountNumbersProductSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountNumbersProductSettings:
        """Create an instance of AccountNumbersProductSettings from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountNumbersProductSettings.parse_obj(obj)

        _obj = AccountNumbersProductSettings.parse_obj(
            {
