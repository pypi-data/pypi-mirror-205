...
class IdentityProductSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityProductSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityProductSettings:
        """Create an instance of IdentityProductSettings from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IdentityProductSettings.parse_obj(obj)

        _obj = IdentityProductSettings.parse_obj(
            {
