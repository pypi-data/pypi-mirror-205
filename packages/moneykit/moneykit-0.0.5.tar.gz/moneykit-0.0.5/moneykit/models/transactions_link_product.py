...
class TransactionsLinkProduct(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionsLinkProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionsLinkProduct:
        """Create an instance of TransactionsLinkProduct from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransactionsLinkProduct.parse_obj(obj)

        _obj = TransactionsLinkProduct.parse_obj(
            {
