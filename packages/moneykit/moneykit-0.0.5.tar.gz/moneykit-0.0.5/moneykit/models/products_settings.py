...
class ProductsSettings(BaseModel):
    ...
    __properties = ["account_numbers", "identity", "transactions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsSettings:
        """Create an instance of ProductsSettings from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductsSettings.parse_obj(obj)

        _obj = ProductsSettings.parse_obj(
            {
                "account_numbers": AccountNumbers.from_dict(obj.get("account_numbers"))
                ...
                "transactions": Transactions.from_dict(obj.get("transactions"))
