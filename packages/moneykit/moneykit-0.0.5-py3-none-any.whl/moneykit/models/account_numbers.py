...
class AccountNumbers(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountNumbers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountNumbers:
        """Create an instance of AccountNumbers from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountNumbers.parse_obj(obj)

        _obj = AccountNumbers.parse_obj(
            {
