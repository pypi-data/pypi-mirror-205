...
class LinkErrorDeletedResponse(BaseModel):
    ...
    def error_code_validate_enum(cls, v):
        if v is None:
            return v
        if v not in ("link_error.deleted"):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkErrorDeletedResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkErrorDeletedResponse:
        """Create an instance of LinkErrorDeletedResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LinkErrorDeletedResponse.parse_obj(obj)

        _obj = LinkErrorDeletedResponse.parse_obj(
            {
                "error_code": obj.get("error_code") if obj.get("error_code") is not None else "link_error.deleted",
                "error_message": obj.get("error_message") if obj.get("error_message") is not None else "Link deleted.",
