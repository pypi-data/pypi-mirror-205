...
class CustomerUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerUser:
        """Create an instance of CustomerUser from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerUser:
        """Create an instance of CustomerUser from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CustomerUser.parse_obj(obj)

        _obj = CustomerUser.parse_obj(
            {
                "id": obj.get("id"),
