...
class XTController(rpyc.Service, LogHelper):
    ...
    def process_multi_run_context(self, multi_run_context_fn):
        ...
        self.log_info("node_log_exists", node_log_exists)
        ...
        '''
        # TODO: support node_stats.pull_star_time and node_stats.pull_duration
        ...
        self.log_info("after_node_log_exists", after_node_log_exists)
