...
def GetListInsta_FG(sessionid,user_target):
    try:
        u6 = f'https://i.instagram.com/api/v1/users/web_profile_info/?username={user_target}'
        hd6 = {
            'accept': '*/*',
            'accept-encoding': 'gzip, deflate, br',
            'accept-language': 'en-US,en;q=0.9',
        ...
        return {'result':'sessionid false','Tele':'@G_4_2'}
    try:
    ...
    'X-Requested-With': 'XMLHttpRequest',
    'Connection': 'keep-alive',
    'Referer': 'https://www.instagram.com/'+str(user_target)+'/following/',
    'TE': 'Trailers'
    }
    aegos22 = 0
            ...
            if aegos22 != 0:
                ...
                try:
                    ...
                    for ns in nu:
                        ...
                        n6 = {'user':f'{n6}'}
                        addlist.append(n6)
                    js = json.dumps(addlist)
                    return {'result':js,'Tele':'@G_4_2'}
                except KeyboardInterrupt:
                    pass
                aegos22 += 1
def GetListInsta_FS(sessionid,user_target):
    try:
        u6 = f'https://i.instagram.com/api/v1/users/web_profile_info/?username={user_target}'
        hd6 = {
            'accept': '*/*',
    ...
    'X-Requested-With': 'XMLHttpRequest',
    'Connection': 'keep-alive',
    'Referer': 'https://www.instagram.com/'+str(user_target)+'/followers/',
    'TE': 'Trailers'
    }
    aegos22 = 0
