...
Key = Literal['idType', 'exchCode', 'micCode', 'currency', 'marketSecDes', 'securityType', 'securityType2', 'stateCode']
...
class NullableDateInterval(list):
    ...
    def validate(cls, v: Any) -> list[str | None]:
        ...
        if v[0] is not None and v[1] is not None and v[0] + dt.timedelta(weeks=52) < v[1]:
