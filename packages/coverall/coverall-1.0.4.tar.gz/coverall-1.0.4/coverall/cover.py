...
def createMatrix(universe, sets, r_or_c):
    #Creates a matrix consisting of a list full of bitarrays.
    #Creates bitarrays out of either the rows or columns dependent on r_or_c
    #Creates a bitarray to indicate all rows are active
    #Creates a bitarray to indicate all columns are active
    #return a list consisting of the matrix list, active_rows, and active columns.
    if r_or_c == 'c':
        set_columns = []
