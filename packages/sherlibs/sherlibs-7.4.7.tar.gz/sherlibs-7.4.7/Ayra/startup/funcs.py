...
async def autobot():
    ...
    if who.username:
        ...
        username = "sherlean_" + (str(who.id))[5:] + "_bot"
    bf = "@BotFather"
    ...
    if isdone.startswith("Sorry,"):
        ran = randint(1, 100)
        username = "sherlean_" + (str(who.id))[6:] + str(ran) + "_bot"
        await ayra_bot.send_message(bf, username)
        await asyncio.sleep(1)
        isdone = (await ayra_bot.get_messages(bf, limit=1))[0].text
...
async def autopilot():
    ...
    if not channel:
        ...
        try:
            r = await ayra_bot(
                CreateChannelRequest(
                    title="sʜᴇᴀʀʟᴇᴀɴ ꭙ͢ ʟᴏɢs",
                    about="**ᴊᴀɴɢᴀɴ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ʟᴏɢ ɢʀᴏᴜᴘ ɪɴɪ . \nʟᴏɢ ᴅɪʙᴜᴀᴛ ᴏʟᴇʜ sʜᴇᴀʀʟᴇᴀɴ ꭙ͢ ᴜsᴇʀʙᴏᴛ.\nғᴏʟʟᴏᴡ ᴄʜᴀɴɴᴇʟ** @SherleanShop",
                    megagroup=True,
                ),
            )
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo = await download_file(
            "https://graph.org/file/3cf7d0ca1e1622be2487f.jpg", "logo.jpg"
        )
...
async def customize():
    ...
    try:
        ...
        file = random.choice(
            [
                "https://graph.org/file/88d966d645f901ccf29e0.jpg",
        ...
        await ayra_bot.send_message(
            "botfather", f"Saya adalah assisten bot milik {sir}"
        )
        await asyncio.sleep(2)
        ...
        await ayra_bot.send_message(
            "botfather",
            f"Saya adalah assisten bot milik {sir} \n\nPowered By ~ @SherleanShop ",
        )
        await asyncio.sleep(2)
        ...
        try:
            async for x in ayra_bot.iter_messages(
                ...
                try:
                    ...
                    LOGS.info(f"Sherlean - PLUGIN_CHANNEL - ERROR - {plugin}")
                    LOGS.exception(e)
                    os.remove(plugin)
        except Exception as er:
            LOGS.exception(er)
...
async def ready():
    ...
    if not udB.get_key("INIT_DEPLOY"):  # Detailed Message at Initial Deploy
        MSG = """ **Thanks for Deploying Sherlean Userbot!**
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://graph.org/file/3cf7d0ca1e1622be2487f.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set_key("INIT_DEPLOY", "Done")
    else:
        MSG = f"**Sherlean Userbot has been deployed!**\n╼┅━━━━━━━━━━━┅╾\n**UserMode**: {inline_mention(ayra_bot.me)}\n**Assistant**: @{asst.me.username}\n╼┅━━━━━━━━━━━┅╾\n**Channel**: @SherleanShop\n╼┅━━━━━━━━━━━┅╾"
