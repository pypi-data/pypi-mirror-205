...
class EventsResponse(BaseModel):
    ...
    __properties = ["total", "continuationToken", "events"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventsResponse:
        ...
        _obj = EventsResponse.parse_obj({
            ...
            "events": [EventResponse.from_dict(_item) for _item in obj.get("events")] if obj.get("events") is not None else None
        })
        return _obj
