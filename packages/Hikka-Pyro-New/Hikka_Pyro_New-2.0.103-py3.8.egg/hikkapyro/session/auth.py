...
from hikkapyro.crypto import aes, rsa, prime
from hikkapyro.errors import SecurityCheckMismatch
from hikkapyro.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "hikkapyro.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
