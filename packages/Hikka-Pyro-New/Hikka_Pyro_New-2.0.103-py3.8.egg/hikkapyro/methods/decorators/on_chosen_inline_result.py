...
import hikkapyro
from hikkapyro.filters import Filter
...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, hikkapyro.Client):
                self.add_handler(hikkapyro.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        hikkapyro.handlers.ChosenInlineResultHandler(func, self),
