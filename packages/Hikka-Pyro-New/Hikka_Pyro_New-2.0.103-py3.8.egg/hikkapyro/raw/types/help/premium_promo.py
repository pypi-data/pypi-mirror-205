...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <hikkapyro.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <hikkapyro.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <hikkapyro.raw.base.PremiumSubscriptionOption>`):
            N/A
