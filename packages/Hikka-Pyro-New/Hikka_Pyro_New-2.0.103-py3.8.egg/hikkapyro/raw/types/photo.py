...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <hikkapyro.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <hikkapyro.raw.base.VideoSize>`, *optional*):
            N/A
