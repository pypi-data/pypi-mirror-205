...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <hikkapyro.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <hikkapyro.raw.base.User>`, *optional*):
            N/A
