...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <hikkapyro.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <hikkapyro.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <hikkapyro.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <hikkapyro.raw.base.InputDocument>`, *optional*):
            N/A
