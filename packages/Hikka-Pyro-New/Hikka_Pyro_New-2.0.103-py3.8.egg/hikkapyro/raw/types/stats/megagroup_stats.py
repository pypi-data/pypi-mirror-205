...
from hikkapyro.raw.core.primitives import Int, Long, Int128, Int256, Bool, Bytes, String, Double, Vector
...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <hikkapyro.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <hikkapyro.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <hikkapyro.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <hikkapyro.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <hikkapyro.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <hikkapyro.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <hikkapyro.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <hikkapyro.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <hikkapyro.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <hikkapyro.raw.base.User>`):
            N/A

    Functions:
        This object can be returned by 1 function.

        .. currentmodule:: hikkapyro.raw.functions
