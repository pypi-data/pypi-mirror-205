...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        peer (:obj:`InputPeer <hikkapyro.raw.base.InputPeer>`, *optional*):
            N/A

        id (List of ``int`` ``32-bit``, *optional*):
            N/A

        text (List of :obj:`TextWithEntities <hikkapyro.raw.base.TextWithEntities>`, *optional*):
            N/A

    Returns:
        :obj:`messages.TranslatedText <hikkapyro.raw.base.messages.TranslatedText>`
    """
