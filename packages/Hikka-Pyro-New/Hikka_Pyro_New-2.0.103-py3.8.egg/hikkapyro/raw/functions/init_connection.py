...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~hikkapyro.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <hikkapyro.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <hikkapyro.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~hikkapyro.raw.types`
    """
