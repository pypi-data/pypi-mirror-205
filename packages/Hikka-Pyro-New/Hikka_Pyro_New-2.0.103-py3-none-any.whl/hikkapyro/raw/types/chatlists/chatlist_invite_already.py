...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <hikkapyro.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <hikkapyro.raw.base.Peer>`):
            N/A
