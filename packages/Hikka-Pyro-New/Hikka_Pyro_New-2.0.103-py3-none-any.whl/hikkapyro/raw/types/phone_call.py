...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hikkapyro.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <hikkapyro.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <hikkapyro.raw.base.PhoneConnection>`):
            N/A
