...
import hikkapyro
from hikkapyro import __version__, __license__
from hikkapyro import enums
from hikkapyro import raw
from hikkapyro import utils
from hikkapyro.crypto import aes
from hikkapyro.errors import CDNFileHashMismatch
from hikkapyro.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from hikkapyro.handlers.handler import Handler
from hikkapyro.methods import Methods
from hikkapyro.session import Auth, Session
from hikkapyro.storage import FileStorage, MemoryStorage
from hikkapyro.types import User, TermsOfService
from hikkapyro.utils import ainput
...
class Client(Methods):
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except hikkapyro.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
