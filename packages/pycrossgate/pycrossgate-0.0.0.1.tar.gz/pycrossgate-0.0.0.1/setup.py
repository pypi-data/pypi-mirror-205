...
setup(
    ...
    description=''' 👨‍💻"pycrossgate" is a Python package that automatically imports missing modules on-the-fly, saving time and effort during coding 🛠️⌛''',
    ...
    url='https://github.com/yourusername/pycrossgate',
    classifiers=[
...
print("(*) pycrossgate to serve you well, thank you!")