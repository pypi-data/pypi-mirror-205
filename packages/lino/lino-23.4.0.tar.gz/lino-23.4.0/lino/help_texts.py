...
user."""),
    ...
    'lino.modlib.linod.Procedure' : _("""Is basically a Job which contains a function func to run at default interval
...
data of that year."""),
    ...
    'lino.modlib.system.DurationUnit' : _("""Base class for the choices in the DurationUnits
choicelist."""),
