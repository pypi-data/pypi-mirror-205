...
class MissingRow():
    ...
    def __init__(self, pointing_field, pointing_choice):
        self.pointing_field = pointing_field
        self.pointing_choice = pointing_choice

    def __str__(self):
        return _("No {} pointing to {}").format(
            self.pointing_field.model._meta.verbose_name, self.pointing_choice)

    def __repr__(self):
        return "{}({})".format(self.__class__.__name__, repr(self.pointing_choice))
