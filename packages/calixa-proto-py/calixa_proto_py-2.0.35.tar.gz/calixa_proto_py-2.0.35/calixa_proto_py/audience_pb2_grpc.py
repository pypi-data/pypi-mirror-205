...
class AudienceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetNextAvailableSyncs = channel.unary_stream(
...
def add_AudienceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetNextAvailableSyncs': grpc.unary_stream_rpc_method_handler(
...
class AudienceService(object):
    ...
    def GetNextAvailableSyncs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.audience.AudienceService/GetNextAvailableSyncs',
