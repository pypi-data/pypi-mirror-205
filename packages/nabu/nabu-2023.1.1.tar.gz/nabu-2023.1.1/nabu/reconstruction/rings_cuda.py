...
class CudaMunchDeringer(MunchDeringer):
    def __init__(self, sigma, sinos_shape=None, levels=None, wname="db15", cuda_options=None):
        """
        ...
        """
        super().__init__(sigma, levels=levels, wname=wname, sinos_shape=sinos_shape)
