...
class StatBaseModel(FrameBaseModel):
    ...
    """
    def __init__(self, context=None,logging_error=None, logging_info=None, db_connect_key='db_cloudapp'):
    ...
    def add_stat(self, app_id, act_id, module_id, user_id, open_id, key_name, key_value, object_id=''):
        ...
        if stat_process_ways == "mysql":
            ...
            stat_queue = stat_queue.__dict__
            stat_queue["db_connect_key"] = self.db_connect_key
