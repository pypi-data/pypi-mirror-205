...
#07L3O00000Dy7SAUAZ
    ...
    def test_log_file(self):
        try:
            res = InCli._main(["-logs","-inputfile",f"/Users/uormaechea/Documents/Dev/python/InCliLib/InCLipkg/incli/logs/07L3O00000EhLJbUAN.log"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_file_allLimits(self):
        try:
            res = InCli._main(["-logs","-inputfile",f"/Users/uormaechea/Documents/Dev/python/InCliLib/InCLipkg/InCli/logs/07L3O00000EXOOEUA5.log","-allLimits"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)
    ...
    def test_log_tail_auto_delete(self):
        try:
            #return
            InCli._main(["-u","DEVNOSCAT4","-logs","-tail","-auto","-deletelogs","-debuglevel","L"])
        except Exception as e:
            utils.printException(e)
            print(traceback.format_exc())
            self.assertTrue(1==2)  
