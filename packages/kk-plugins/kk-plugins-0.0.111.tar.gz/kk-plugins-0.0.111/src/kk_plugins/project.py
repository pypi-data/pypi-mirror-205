...
class StartProject:
    ...
    def create_python(self):
        tmpl = Template(requests.get(
            'https://gist.githubusercontent.com/wgnpj2cg/479177b348504da61547df1d3925bb9e/raw/eadbe64797b7c3c3e91dd4840cdf3fa8b7cca752/python_docker_build_publish.tpl').text).render()
