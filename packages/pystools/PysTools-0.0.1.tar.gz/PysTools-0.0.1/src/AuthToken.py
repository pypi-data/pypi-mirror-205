...
from sResponse import BizException
from config.enumerations import ResponseCode

exp_seconds = 60 * 60 * 6

secret_key = "ca42ce27b859f6b361a718877aac6872"


def generate_token(payload_data, **kwargs):
...
def validate_token(astoken: str = Header(...)):
    key = secret_key
    try:
        ...
        raise BizException(ResponseCode.TOKEN_INVALID.code, "登录状态过期或无效")
