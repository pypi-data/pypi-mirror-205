...
class FeishuShortCut(object):
    @staticmethod
    def update_bitable_record(feishu:Feishu,file_token, table_id, update_data, record_id=None):
        """
        更新多维表格的数据
        :param feishu:
        :param file_token:
        ...
        res = feishu.bitable_records(file_token, table_id, record_id=record_id, req_body=data)
        return res
...
if __name__ == '__main__':
    feishu = Feishu(app_id="cli_a36c4f51bb7c900e", app_secret="qza9GGNFfl04cp7hg1JYfJL2ESuL5srd")

    file_token = "I4KVb8b8qaxo3tsMY0QchZKBnNg"
    table_id = "tbl49aOR992KEe5S"
