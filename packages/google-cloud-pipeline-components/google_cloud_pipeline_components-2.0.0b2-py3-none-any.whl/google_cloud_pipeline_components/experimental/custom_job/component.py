...
def custom_training_job(
  ...
  Args:
      ...
      location (Optional[str]):
        Location for creating the custom training job.
        If not set, default to us-central1.
      display_name (str):
        The name of the custom training job.
      worker_pool_specs (Optional[Sequence[str]]):
        Serialized json spec of the
      ...
      tensorboard (Optional[str]):
        The name of a Vertex AI Tensorboard resource
