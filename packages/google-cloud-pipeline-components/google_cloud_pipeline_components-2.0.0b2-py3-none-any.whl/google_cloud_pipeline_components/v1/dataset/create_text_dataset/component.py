...
def text_dataset_create(
  ...
  Args:
      ...
      import_schema_uri (String):
        Points to a YAML file stored on Google
      ...
      data_item_labels (Dict):
        Optiona. Labels that will be applied to
        ...
        refenced by ``import_schema_uri``, e.g. jsonl file.
      project (String):
  ...
  Returns:
      text_dataset (VertexDataset):
          Instantiated representation of the managed text dataset
          resource.
  """
  # fmt: on
