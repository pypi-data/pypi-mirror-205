...
DEFAULT_CONTAINER_IMAGE = (
    'gcr.io/ml-pipeline/google-cloud-pipeline-components:2.0.0b2'
)
...
PARAMS_TO_REMOVE = frozenset({'self', 'credentials', 'sync'})
...
def generate_docstring(
  ...
  if parsed_docstring.raises:
    doc += 'Raises:\n'
    raises_dict = {p.type_name: p.description for p in parsed_docstring.raises}
