...
class StreamsyncState():
    ...
    def add_mail(self, type: str, payload: Any) -> None:
        try:
            ...
            self.session_state.add_log_entry("error", "Mail processing failed",
                                             f"A runtime exception was raised when adding mail of type '{ type }'.", traceback.format_exc())
...
class SessionManager:
    ...
    def reset_state_for_all(self) -> None:
