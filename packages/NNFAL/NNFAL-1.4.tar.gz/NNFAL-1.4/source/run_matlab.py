...
#example.append(['AT AT6c','runlim -s 6144 -r 3600 dnnf ../property/AT/property_66c.py --network N ../network/AT/AT_NN-1.onnx  --save-violation violation'])


#For AFC or Powertrain
#example.append(['AFC_P AFC33','runlim -s 6144 -r 3600 dnnf ../property/AFC_P/property_11.py --network N ../network/AFC_P/AFC_v2.onnx  --save-violation violation'])



#For Steam Condenser
#example.append(['SC P1','runlim -s 6144 -r 3600 dnnf ../property/SC/property_11.py --network N ../network/SC/SC_NN-1.onnx  --save-violation violation'])


#For Chasing Cars...
#example.append(['CC CC1','runlim -s 6144 -r 3600 dnnf ../property/Chasing_cars/property_111.py --network N ../network/Chasing_cars/CC_v1.onnx  --save-violation violation'])



#table_fields = ['Property name','#Experiments', '#Refinements', 'DNNF_Time', 'Refine_Time','Validation_Time', 'D+V_Time', 'Overall_time']
...
"""
	pt.add_row(["","","","","","","",""])
	with open('resul_NNFal.txt', 'a') as f:
    		f.write(str(pt))
	f.close()
print(pt)
with open('result_NNFal_copy.txt', 'a') as f:
    f.write(str(pt))
"""
