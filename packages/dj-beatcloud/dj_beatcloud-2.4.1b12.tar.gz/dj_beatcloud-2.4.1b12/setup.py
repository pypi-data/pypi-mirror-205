...
entry_point = f'{Path(__file__).resolve().parent}:dj_tools.main'
setup(
    name='dj_beatcloud',
    version='2.4.1-b12',
    description=(
    ...
    # entry_points={'console_scripts': [f'djtools={entry_point}']},
    entry_points={'console_scripts': [f'djtools=dj_tools.main']},
)
