...
setup(
    ...
    url='https://github.com/Hiyoteam/sgplib', # 你的项目主页，一般为github仓库地址
    author='Hiyoteam', # 你的姓名或者团队名称
    author_email='tanhanzesnd@gmail.com', # 你的邮箱或者团队邮箱
    license='AGPL-3.0', # 你的项目使用的许可证，一般为MIT或者其他开源许可证
    ...
    keywords='network socket', # 一些关键词，用于描述你的项目特点或者功能
    packages=["sgplib"], # 需要打包的python模块，一般使用find_packages函数自动查找，排除测试模块等不需要打包的模块
    install_requires=[]
)