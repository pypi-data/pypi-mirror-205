...
@headless
@with_version
def easy(url, instance, version=None, headless=False):
...
@with_instance_id
@with_version
def port(url, token, instance, version):
...
@headless
@with_version
def custom(builder, token, instance, version=None, headless=False):
...
@headless
@with_version
def dev(url, instance, builder, deep, version=None, headless=False):
