...
def estimate_linear_response_region(
    ranges,
    an,
    pc,
    an_bg,
    ...
    if np.logical_and(
        ...
        if len(rvalue_arr) > 0:
            ...
            linear_region = False
            idx_lr, slope, intercept, r2, h_lr_min, h_lr_max = (
                np.nan,
                np.nan,
                np.nan,
                np.nan,
