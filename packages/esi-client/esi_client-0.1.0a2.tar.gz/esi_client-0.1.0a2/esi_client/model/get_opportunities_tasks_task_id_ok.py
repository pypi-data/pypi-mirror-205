...
class GetOpportunitiesTasksTaskIdOk(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, name, notification, task_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, name, notification, task_id, *args, **kwargs):  # noqa: E501
        """GetOpportunitiesTasksTaskIdOk - a model defined in OpenAPI
