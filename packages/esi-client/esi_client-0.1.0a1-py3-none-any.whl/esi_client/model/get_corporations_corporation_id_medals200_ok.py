...
class GetCorporationsCorporationIdMedals200Ok(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, creator_id, description, medal_id, title, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, creator_id, description, medal_id, title, *args, **kwargs):  # noqa: E501
        """GetCorporationsCorporationIdMedals200Ok - a model defined in OpenAPI
