...
class PostUniverseNames200Ok(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, category, id, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, category, id, name, *args, **kwargs):  # noqa: E501
        """PostUniverseNames200Ok - a model defined in OpenAPI
