...
class IncursionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_incursions_endpoint = _Endpoint(
            settings={
                'response_type': ([GetIncursions200Ok],),
                'auth': [],
                'endpoint_path': '/incursions/',
                'operation_id': 'get_incursions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_incursions(
        ...
        **kwargs
        ...
        return self.get_incursions_endpoint.call_with_http_info(**kwargs)
