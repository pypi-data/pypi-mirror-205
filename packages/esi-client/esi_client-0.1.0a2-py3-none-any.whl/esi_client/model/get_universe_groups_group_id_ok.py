...
class GetUniverseGroupsGroupIdOk(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, category_id, group_id, name, published, types, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, category_id, group_id, name, published, types, *args, **kwargs):  # noqa: E501
        """GetUniverseGroupsGroupIdOk - a model defined in OpenAPI
