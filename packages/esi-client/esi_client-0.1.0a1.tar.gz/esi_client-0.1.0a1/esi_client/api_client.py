...
from esi_client.exceptions import ApiTypeError, ApiValueError, ApiException
from esi_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AllianceApi()
        api_instance.get_alliances  # this is an instance of the class Endpoint
        api_instance.get_alliances()  # this invokes api_instance.get_alliances.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_alliances.callable or self.callable in this class
