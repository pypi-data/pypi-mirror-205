...
class GetInsurancePricesLevel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cost, name, payout, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, cost, name, payout, *args, **kwargs):  # noqa: E501
        """GetInsurancePricesLevel - a model defined in OpenAPI
