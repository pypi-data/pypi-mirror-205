...
class GetCharactersCharacterIdCalendarEventIdOk(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, duration, event_id, importance, owner_id, owner_name, owner_type, response, text, title, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, duration, event_id, importance, owner_id, owner_name, owner_type, response, text, title, *args, **kwargs):  # noqa: E501
        """GetCharactersCharacterIdCalendarEventIdOk - a model defined in OpenAPI
