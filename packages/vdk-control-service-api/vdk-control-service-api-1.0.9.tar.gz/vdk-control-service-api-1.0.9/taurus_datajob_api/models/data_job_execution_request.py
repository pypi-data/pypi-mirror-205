...
class DataJobExecutionRequest(BaseModel):
    """
    ...
    args: Optional[Dict[str, Any]] = Field(None, description="Data Job arguments")
    __properties = ["started_by", "args"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataJobExecutionRequest:
        """Create an instance of DataJobExecutionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataJobExecutionRequest:
        """Create an instance of DataJobExecutionRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataJobExecutionRequest.parse_obj(obj)

        _obj = DataJobExecutionRequest.parse_obj({
