...
class DataJobSchedule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataJobSchedule:
        """Create an instance of DataJobSchedule from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataJobSchedule:
        """Create an instance of DataJobSchedule from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataJobSchedule.parse_obj(obj)

        _obj = DataJobSchedule.parse_obj({
