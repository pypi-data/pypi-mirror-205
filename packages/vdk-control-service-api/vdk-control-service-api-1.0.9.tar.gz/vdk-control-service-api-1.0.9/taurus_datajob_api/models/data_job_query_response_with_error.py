...
class DataJobQueryResponseWithError(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataJobQueryResponseWithError:
        """Create an instance of DataJobQueryResponseWithError from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataJobQueryResponseWithError:
        """Create an instance of DataJobQueryResponseWithError from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataJobQueryResponseWithError.parse_obj(obj)

        _obj = DataJobQueryResponseWithError.parse_obj({
