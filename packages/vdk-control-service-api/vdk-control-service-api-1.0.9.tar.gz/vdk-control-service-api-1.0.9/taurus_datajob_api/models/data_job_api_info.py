...
class DataJobApiInfo(BaseModel):
    """
    API and Data Job service information, list of supported python versions
    """
    api_version: StrictStr = ...
    supported_python_versions: conlist(StrictStr) = Field(..., description="list of supported python versions")
    __properties = ["api_version", "supported_python_versions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataJobApiInfo:
        """Create an instance of DataJobApiInfo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataJobApiInfo:
        """Create an instance of DataJobApiInfo from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataJobApiInfo.parse_obj(obj)

        _obj = DataJobApiInfo.parse_obj({
            "api_version": obj.get("api_version"),
            "supported_python_versions": obj.get("supported_python_versions")
        })
        return _obj
