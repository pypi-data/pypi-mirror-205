...
class DataJob(BaseModel):
    ...
    description: StrictStr = Field(..., description="Short Data Job description")
    config: DataJobConfig = ...
    team: Optional[StrictStr] = Field(None, description="(Optional) Team name")
    __properties = ["job_name", "description", "config", "team"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataJob:
        """Create an instance of DataJob from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataJob:
        """Create an instance of DataJob from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataJob.parse_obj(obj)

        _obj = DataJob.parse_obj({
            "job_name": obj.get("job_name"),
            "description": obj.get("description"),
            "config": DataJobConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None,
            "team": obj.get("team")
        })
        return _obj
