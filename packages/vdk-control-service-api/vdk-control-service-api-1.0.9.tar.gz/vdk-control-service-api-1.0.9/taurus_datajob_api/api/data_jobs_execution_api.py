...
class DataJobsExecutionApi(object):
    ...
    @validate_arguments
    def data_job_execution_cancel_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], execution_id : Annotated[StrictStr, Field(..., description="Execution ID.")], **kwargs):  # noqa: E501
        """Cancel (if running) Data Job Execution | (Experimental)  # noqa: E501
    ...
    @validate_arguments
    def data_job_execution_list_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], execution_status : Annotated[Optional[conlist(StrictStr)], Field(description="Execution status")] = None, **kwargs):  # noqa: E501
        """Get Data Jobs (recent) executions. (Execution API is still experimental and must not be used in production) | (Experimental)  # noqa: E501
    ...
    @validate_arguments
    def data_job_execution_read_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], execution_id : Annotated[StrictStr, Field(..., description="Execution ID.")], **kwargs):  # noqa: E501
        """Get Data Job Execution details. | (Experimental)  # noqa: E501
    ...
    def data_job_execution_start_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], deployment_id : Annotated[StrictStr, Field(..., description="Data job deployment ID. Currently it is being ignored as multiple deployments are not implemented.")], data_job_execution_request : Optional[DataJobExecutionRequest] = None, **kwargs):  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['data_job_execution_request']:
