...
class DataJobsPropertiesApi(object):
    ...
    @validate_arguments
    def data_job_properties_read_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], deployment_id : Annotated[StrictStr, Field(..., description="Data job deployment id.")], **kwargs):  # noqa: E501
        """Get Data Job properties.  # noqa: E501
    ...
    @validate_arguments
    def data_job_properties_update_with_http_info(self, team_name : Annotated[StrictStr, Field(..., description="Team Name")], job_name : Annotated[StrictStr, Field(..., description="Data Job Name.")], deployment_id : Annotated[StrictStr, Field(..., description="Data job deployment id.")], request_body : Dict[str, Any], **kwargs):  # noqa: E501
        """Update Data Job properties.  # noqa: E501
