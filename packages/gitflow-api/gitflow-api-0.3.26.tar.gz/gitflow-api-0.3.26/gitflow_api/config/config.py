...
class Config:
    ...
    def _set_extension(self):
        ...
        self.extension_username = self._get_property('EXTENSION', 'username', None)
        self.extension_password = self._get_property('EXTENSION', 'password', None)
