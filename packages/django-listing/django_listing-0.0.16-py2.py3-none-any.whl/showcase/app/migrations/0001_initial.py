    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.Company', verbose_name='Company')),
                ('interests', models.ManyToManyField(to='app.Interest', verbose_name='Interests')),
            ],
        ),
    ]
