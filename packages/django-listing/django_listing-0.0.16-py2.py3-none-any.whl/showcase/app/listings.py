...
class EmployeeModelListing(Listing):
    ...
    #paginator_template_name = 'app/paginator_bootstrap.html'
...
class BoolChoicesImgColumnsListing(Listing):
    ...
    have_car__true_tpl = ( '<img src="{STATIC_URL}app/images/car.png"'
                           'title="Have a car">')
    have_car__false_tpl = ('<img src="{STATIC_URL}app/images/pedestrian.png" '
                           'title="Do not own a car">')
    have_car__theme_cell_class = 'text-center'
    gender__choices = (
        ('Male', '<img src="{STATIC_URL}app/images/male.png" '
                 'title="{value}">'),
        ('Female', '<img src="{STATIC_URL}app/images/female.png" '
                   'title="{value}">'),
    )
...
class ToolbarEmployeeBigThumbnailsListing(ToolbarEmployeeThumbnailsListing):
    div_template_name = 'app/big_thumbnails.html'
    per_page = 9
...
class UploadListing(DivListing):
    ...
    div_template_name = 'app/upload_thumbnails.html'
    attrs = {'class':''}
    # will add the 'thumbnail' class to the container
    # means that one have to set 'div.row-container.thumbnail'
    # in .css to modify the look
