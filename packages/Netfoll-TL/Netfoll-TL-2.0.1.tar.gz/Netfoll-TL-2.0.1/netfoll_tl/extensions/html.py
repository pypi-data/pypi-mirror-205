...
from netfoll_tl.tl.types import (MessageEntityBlockquote, MessageEntityBold,
                               ...
                               MessageEntityUrl, TypeMessageEntity)
...
class TextDecoration(ABC):
    def apply_entity(self, entity, text: str) -> str:
        ...
        if any(isinstance(entity, entity_) for entity_ in entity_map):
        ...
        if isinstance(entity, MessageEntityCustomEmoji) and CUSTOM_EMOJIS:
