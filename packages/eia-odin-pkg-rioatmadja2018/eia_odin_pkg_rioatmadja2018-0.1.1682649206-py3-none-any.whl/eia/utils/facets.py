...
from eia.utils.constants import STATE, REGION
from typing import Dict

def get_facets(facet_name: str) -> Dict:

    all_facets: Dict = {}
    browser: 'Browser' = Browser(endpoint=f"https://api.eia.gov/v2/{facet_name}/facet/series?api_key=CZdQsisRJzwOfqUWV3jiMPNEx3ZbHcuJ2VQus04i")
