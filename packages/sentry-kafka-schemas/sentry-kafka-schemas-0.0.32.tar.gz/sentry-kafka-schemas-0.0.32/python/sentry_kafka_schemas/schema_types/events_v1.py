from typing import Dict, Union, Literal, Tuple, Any, TypedDict, List
...
class _BaseGen459482(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
