from typing import Any, Union, Tuple, Dict, Literal, TypedDict, List
...
class _BaseGen515889(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
