...
l_convert_error = {
    'ru': "👩🏽‍💻 <b>Ошибка</b> преобразования контента (попробуйте позже ии загрузите другой файл)",
...
l_telegraph_error = {
    'ru': "👩🏽‍💻 <b>Ошибка</b> получения ссылки (попробуйте позже ии загрузите другой файл)",
