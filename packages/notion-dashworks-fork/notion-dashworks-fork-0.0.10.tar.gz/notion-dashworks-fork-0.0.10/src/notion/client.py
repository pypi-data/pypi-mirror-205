...
class NotionClient(object):
    ...
    def __init__(
        ...
        client_specified_retry:Optional[None]=None,
    ) -> None:
    ...
    def get_block(self, url_or_id: str, force_refresh:bool=False, limit:int=100) -> Union[TemplateBlock, CollectionRowBlock, Block, None]:
        """
    ...
    def search(
        self,
        query:str="",
        search_type:str="BlocksInSpace",
        limit:int=100,
        sort:str="Relevance",
        source:str="quick_find",
        isDeletedOnly:bool=False,
        excludeTemplates:bool=False,
        isNavigableOnly:bool=False,
        requireEditPermissions:bool=False,
        ancestors:List[str]=[],
        createdBy:List[str]=[],
        editedBy:List[str]=[],
        lastEditedTime:Dict[str, Any]={},
        createdTime:Dict[str, Any]={},
    ) -> List[Union[TemplateBlock, CollectionRowBlock, Block]]:
        data = {
            "type": search_type,
            "query": query,
            "spaceId": self.current_space.id,
