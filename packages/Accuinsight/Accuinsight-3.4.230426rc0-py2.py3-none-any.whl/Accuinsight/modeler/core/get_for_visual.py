...
def roc_pr_curve(model, X_test, y_test, f1_average, recall_average, *args):
    ...
    res_dict['chart'] = {'AUC': res_roc['auc']['micro'],
                         ...
                         'Recall': recall_score(y_test, y_pred, average=recall_average),
                         'F1-score': f1_score(y_test, y_pred, average=f1_average)}
    return res_dict
