...
def set_evl_json_path(json_path=None):
    global _runData
    run_obj = _runData[0]
    run_obj[LcConst.RUN_OBJ_EVL_JSON_PATH] = json_path

def set_optimizer_info_path(json_path=None):
    global _runData
    run_obj = _runData[0]
    run_obj[LcConst.RUN_OBJ_OPT_INFO] = json_path

def set_selected_metrics_path(json_path=None):
    global _runData
    run_obj = _runData[0]
    run_obj[LcConst.SELECTED_METRICS] = json_path
