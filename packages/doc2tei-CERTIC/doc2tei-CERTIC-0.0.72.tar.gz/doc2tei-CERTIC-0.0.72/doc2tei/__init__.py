...
def _process_doc(
    ...
    #
    success, output = _call_saxon(
        xsl_path="xsl-04-group/floatingText-hierarchize.xsl",
        source_path=f"{doc_file_no_extension}_04d_floatingText.xml",
        destination_path=f"{doc_file_no_extension}_04e_floatingText.xml",
        logger=logger,
        transient_files=transient_files,
    )
    if not success:
    ...
    success, output = _call_saxon(
        ...
        source_path=f"{doc_file_no_extension}_04e_floatingText.xml",
