...
class EmailCreateContactRoleEnum(str, Enum):
    FROM = 'from'
    TO = 'to'
    CC = 'cc'
    BCC = 'bcc'
...
class EmailCreateContact:
    ...
    role: Optional[EmailCreateContactRoleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('role'), 'exclude': lambda f: f is None }})

    
class EmailCreateLeadRoleEnum(str, Enum):
    FROM = 'from'
    TO = 'to'
    CC = 'cc'
    BCC = 'bcc'
...
class EmailCreateLead:
    ...
    role: Optional[EmailCreateLeadRoleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('role'), 'exclude': lambda f: f is None }})
