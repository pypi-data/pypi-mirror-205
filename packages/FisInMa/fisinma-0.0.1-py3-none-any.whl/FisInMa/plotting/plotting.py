...
def plot_all_observables(fsr: FisherResults, fsr_plot=None, outdir=Path("."), additional_name=""):
    ...
    for i, (sol, sol_new) in enumerate(zip(fsr.individual_results, fsr_plot.individual_results)):
        ...
        for j in range(n_obs):
            plot_template(fsr, sol, sol_new, sol.observables[j], sol_new.observables[j], outdir, additional_name, "Observable", i, j)


def plot_all_sensitivities(fsr: FisherResults, fsr_plot=None, outdir=Path("."), additional_name=""):
    ...
    for i, (sol, sol_new) in enumerate(zip(fsr.individual_results, fsr_plot.individual_results)):
        ...
        for j, k in itertools.product(range(n_obs), range(n_p_full)):
            plot_template(fsr, sol, sol_new, sol.sensitivities[k, j], sol_new.sensitivities[k, j], outdir, additional_name, "Sensitivity", i, j, k)


def plot_all_solutions(fsr: FisherResults, fsr_plot=None,  outdir=Path("."), additional_name=""):
    ...
    plot_all_odes(fsr, fsr_plot, outdir, additional_name)
    plot_all_sensitivities(fsr, fsr_plot, outdir, additional_name)
