...
class SoftmaxLayer(BaseLayer):
    ...
    def load_weights(self, **kwargs):
        ...
        self.quanto_b = kwargs["quant_output_k"]
        self.quanto_k = kwargs["quant_output_offset"]

    def forward_pass(self, inputv):
        self.outputv = softmax(inputv/self.quanto_b + self.quanto_k) #TODO: controllare se è la stessa softmax di tfLITE 
