...
class __attribute__((annotate("vineyard"))) ArrowFragment
  ...
  public:
    void Construct(const ObjectMeta& meta) override {
        ...
        meta.GetKeyValue("oid_type_", this->oid_type_);
        meta.GetKeyValue("vid_type_", this->vid_type_);
...
public:
 ...
 public:
  ...
  const std::string vid_typename() const override { return vid_type_; }

  const std::string oid_typename() const override { return oid_type_; }
 ...
 private:
  ...
  __attribute__((annotate("shared"))) String oid_type_, vid_type_;
...
class ArrowFragmentBaseBuilder: public ObjectBuilder {
  public:
    ...
    explicit ArrowFragmentBaseBuilder(
        ...
        this->set_oid_type_(__value.oid_type_);
        this->set_vid_type_(__value.vid_type_);
        this->set_ivnums_(
    ...
    Status _Seal(Client& client, std::shared_ptr<Object>& object) override {
        ...
        __value->oid_type_ = oid_type_;
        __value->meta_.AddKeyValue("oid_type_", __value->oid_type_);

        __value->vid_type_ = vid_type_;
        __value->meta_.AddKeyValue("vid_type_", __value->vid_type_);
  ...
  protected:
    ...
    void set_oid_type_(String const &oid_type__) {
        this->oid_type_ = oid_type__;
    }

    void set_vid_type_(String const &vid_type__) {
        this->vid_type_ = vid_type__;
    }
