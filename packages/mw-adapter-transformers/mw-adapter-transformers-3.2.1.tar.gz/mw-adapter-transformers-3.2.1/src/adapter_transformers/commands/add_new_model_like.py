...
from adapter_transformers.models.auto.configuration_auto import model_type_to_module_name
...
def get_module_from_file(module_file: Union[str, os.PathLike]) -> str:
    ...
    while idx >= 0 and module_parts[idx] != "adapter_transformers":
        idx -= 1
    if idx < 0:
...
class AddNewModelLikeCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        if self.path_to_repo is not None:
            ...
            TRANSFORMERS_PATH = REPO_PATH / "src" / "adapter_transformers"
