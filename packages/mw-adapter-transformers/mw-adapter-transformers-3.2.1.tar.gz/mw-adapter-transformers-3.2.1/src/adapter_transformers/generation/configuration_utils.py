...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.transformers_version = kwargs.pop("adapter_transformers_version", __version__)

    def __eq__(self, other):
        self_dict = self.__dict__.copy()
        other_dict = other.__dict__.copy()
        # ignore metadata
        for metadata_field in ("_from_model_config", "_commit_hash", "adapter_transformers_version"):
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import GenerationConfig
    ...
    def to_diff_dict(self) -> Dict[str, Any]:
        ...
        for key, value in config_dict.items():
            if key not in default_config_dict or key == "adapter_transformers_version" or value != default_config_dict[key]:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        output["adapter_transformers_version"] = __version__
