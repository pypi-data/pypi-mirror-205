...
from adapter_transformers.tokenization_utils import BatchEncoding
from adapter_transformers.utils import ModelOutput, is_tf_available, is_torch_available
...
def convert_pytorch(nlp: Pipeline, opset: int, output: Path, use_external_format: bool):
    ...
    from adapter_transformers.pytorch_utils import is_torch_less_than_1_11
