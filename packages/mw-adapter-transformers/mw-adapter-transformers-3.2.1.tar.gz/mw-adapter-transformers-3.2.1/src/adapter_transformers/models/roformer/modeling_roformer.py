...
# Copied from adapter_transformers.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->RoFormer
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfOutput with Bert->RoFormer
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertIntermediate with Bert->RoFormer
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOutput with Bert->RoFormer
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert->RoFormer
...
class RoFormerForCausalLM(RoFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RoFormerForCausalLM, RoFormerConfig
        >>> import torch
