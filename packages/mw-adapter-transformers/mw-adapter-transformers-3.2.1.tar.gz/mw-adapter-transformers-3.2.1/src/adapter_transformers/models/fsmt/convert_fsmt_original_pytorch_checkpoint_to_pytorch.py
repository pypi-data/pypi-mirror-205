...
from adapter_transformers import FSMTConfig, FSMTForConditionalGeneration
from adapter_transformers.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from adapter_transformers.tokenization_utils_base import TOKENIZER_CONFIG_FILE
from adapter_transformers.utils import WEIGHTS_NAME, logging
...
def convert_fsmt_checkpoint_to_pytorch(fsmt_checkpoint_path, pytorch_dump_folder_path):
    ...
    print(f"adapter_transformers-cli upload {model_dir}")
