...
class M2M100Config(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import M2M100Model, M2M100Config
...
class M2M100OnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    # Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_default_and_seq2seq_lm
