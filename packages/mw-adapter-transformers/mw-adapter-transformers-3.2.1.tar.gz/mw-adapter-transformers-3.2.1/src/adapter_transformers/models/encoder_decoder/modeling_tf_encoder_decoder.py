...
class TFEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from adapter_transformers import TFEncoderDecoderModel
        ...
        if from_pt:
            ...
            from adapter_transformers import EncoderDecoderModel
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import TFEncoderDecoderModel, BertTokenizer
