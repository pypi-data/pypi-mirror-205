...
# Copied from adapter_transformers.models.bert.modeling_tf_bert.TFBertPreTrainingLoss
...
class TFMobileBertForPreTraining(TFMobileBertPreTrainedModel, TFMobileBertPreTrainingLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import AutoTokenizer, TFMobileBertForPreTraining
...
class TFMobileBertForNextSentencePrediction(TFMobileBertPreTrainedModel, TFNextSentencePredictionLoss):
    ...
    def call(
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import AutoTokenizer, TFMobileBertForNextSentencePrediction
    ...
    # Copied from adapter_transformers.models.bert.modeling_tf_bert.TFBertForNextSentencePrediction.serving_output
