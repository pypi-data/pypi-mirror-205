...
class SqueezeBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import SqueezeBertConfig, SqueezeBertModel
...
# # Copied from adapter_transformers.models.bert.configuration_bert.BertOnxxConfig with Bert->SqueezeBert
