...
class DebertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import DebertaConfig, DebertaModel
...
# Copied from adapter_transformers.models.deberta_v2.configuration_deberta_v2.DebertaV2OnnxConfig
