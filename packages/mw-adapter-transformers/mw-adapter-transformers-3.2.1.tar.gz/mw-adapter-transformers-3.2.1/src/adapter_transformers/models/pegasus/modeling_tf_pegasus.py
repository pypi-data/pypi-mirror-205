...
# Copied from adapter_transformers.models.marian.modeling_tf_marian.TFMarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->Pegasus
...
# Copied from adapter_transformers.models.mbart.modeling_tf_mbart.TFMBartEncoderLayer with MBart->Pegasus
...
# Copied from adapter_transformers.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer with MBart->Pegasus
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, TFPegasusForConditionalGeneration
