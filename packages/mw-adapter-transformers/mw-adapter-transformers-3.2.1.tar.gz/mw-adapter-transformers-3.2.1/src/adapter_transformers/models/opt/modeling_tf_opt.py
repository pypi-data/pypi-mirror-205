...
# Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->OPT
...
class TFOPTPreTrainedModel(TFPreTrainedModel):
    """
    TFOPT Pretrained Model that inheritates from adapter_transformers.TFPreTrainedModel
