...
# Copied from adapter_transformers.models.longformer.modeling_longformer.LongformerSelfAttention with Longformer->LEDEncoder
...
@dataclass
# Copied from adapter_transformers.models.longformer.modeling_longformer.LongformerBaseModelOutput with Longformer->LEDEncoder
...
LED_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import AutoTokenizer, LEDForConditionalGeneration
