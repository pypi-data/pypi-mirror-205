...
# Copied from adapter_transformers.models.clip.modeling_tf_clip.clip_loss with clip->groupvit
...
# Adapted from adapter_transformers.models.vit.modeling_tf_vit.TFViTPatchEmbeddings with ViT->GroupViT
...
# Adapted from adapter_transformers.vit.modeling_tf_vit.TFViTEmbeddings
...
# Copied from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPTextEmbeddings with CLIP->GroupViT
...
# Adapted from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPAttention
class TFGroupViTAttention(tf.keras.layers.Layer):
    ...
    # Copied from adapter_transformers.models.bert.modeling_tf_bert.TFBertSelfAttention.transpose_for_scores
...
# Copied from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPEncoderLayer with CLIP->GroupViT
...
# Adapted from adapter_transformers.models.clip.modeling_tf_clip.TFGroupViTTextEncoder
...
# Copied from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPTextTransformer with CLIPText->GroupViTText, CLIPEncoder->GroupViTTextEncoder
...
# Adapted from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPVisionTransformer
...
@keras_serializable
# Copied from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPTextMainLayer with CLIP->GroupViT
...
@keras_serializable
# Copied from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPVisionMainLayer with CLIP->GroupViT
...
@keras_serializable
# Adapted from adapter_transformers.models.clip.modeling_tf_clip.TFCLIPMainLayer
...
class TFGroupViTTextModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import CLIPTokenizer, TFGroupViTTextModel
...
class TFGroupViTVisionModel(TFGroupViTPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, TFGroupViTVisionModel
...
class TFGroupViTModel(TFGroupViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import CLIPTokenizer, TFGroupViTModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, TFGroupViTModel
