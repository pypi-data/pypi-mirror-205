...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->Speech2Text
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Speech2Text
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Speech2Text
...
class Speech2TextModel(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        Example:
         ...
         ```python
         >>> import torch
         >>> from adapter_transformers import Speech2TextModel, AutoFeatureExtractor
...
class Speech2TextForConditionalGeneration(Speech2TextPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
        >>> from datasets import load_dataset
