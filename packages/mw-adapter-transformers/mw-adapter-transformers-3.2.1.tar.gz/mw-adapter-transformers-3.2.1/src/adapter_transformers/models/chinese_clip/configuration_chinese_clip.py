...
class ChineseCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import ChineseCLIPTextConfig, ChineseCLIPTextModel
...
class ChineseCLIPVisionConfig(PretrainedConfig):
    ...
    Example:
    ```python
    >>> from adapter_transformers import ChineseCLIPVisionConfig, ChineseCLIPVisionModel
...
class ChineseCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import ChineseCLIPConfig, ChineseCLIPModel
