...
class DetrModel(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DetrModel
...
class DetrForObjectDetection(DetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DetrForObjectDetection
        >>> import torch
        >>> from PIL import Image
        >>> import requests
...
class DetrForSegmentation(DetrPreTrainedModel):
    ...
    def forward(
        ...
        >>> from adapter_transformers import AutoImageProcessor, DetrForSegmentation
