...
from adapter_transformers.feature_extraction_utils import BatchFeature
from adapter_transformers.image_processing_utils import BaseImageProcessor, get_size_dict
from adapter_transformers.image_transforms import (
    PaddingMode,
...
from adapter_transformers.image_utils import (
...
from adapter_transformers.utils import (
    is_flax_available,
    is_jax_tensor,
    is_scipy_available,
    is_tf_available,
...
from adapter_transformers.utils.generic import ExplicitEnum, TensorType
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_size_with_aspect_ratio
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_resize_output_image_size
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_numpy_to_framework_fn
...
# Copied from adapter_transformers.models.detr.image_processing_detr.safe_squeeze
...
# Copied from adapter_transformers.models.detr.image_processing_detr.normalize_annotation
...
# Copied from adapter_transformers.models.detr.image_processing_detr.max_across_indices
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_max_height_width
...
# Copied from adapter_transformers.models.detr.image_processing_detr.make_pixel_mask
...
# Copied from adapter_transformers.models.detr.image_processing_detr.convert_coco_poly_to_mask
...
# Copied from adapter_transformers.models.detr.image_processing_detr.prepare_coco_detection_annotation with DETR->ConditionalDetr
...
# Copied from adapter_transformers.models.detr.image_processing_detr.masks_to_boxes
...
# Copied from adapter_transformers.models.detr.image_processing_detr.prepare_coco_panoptic_annotation with DETR->ConditionalDetr
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_segmentation_image
...
# Copied from adapter_transformers.models.detr.image_processing_detr.get_mask_area
...
# Copied from adapter_transformers.models.detr.image_processing_detr.score_labels_from_class_probabilities
...
# Copied from adapter_transformers.models.detr.image_processing_detr.post_process_panoptic_sample with DetrForSegmentation->ConditionalDetrForSegmentation
...
# Copied from adapter_transformers.models.detr.image_processing_detr.resize_annotation
...
# Copied from adapter_transformers.models.detr.image_processing_detr.binary_mask_to_rle
...
# Copied from adapter_transformers.models.detr.image_processing_detr.convert_segmentation_to_rle
...
# Copied from adapter_transformers.models.detr.image_processing_detr.remove_low_and_no_objects
...
# Copied from adapter_transformers.models.detr.image_processing_detr.check_segment_validity
...
# Copied from adapter_transformers.models.detr.image_processing_detr.compute_segments
...
class ConditionalDetrImageProcessor(BaseImageProcessor):
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.__init__
    def __init__(
        self,
    ...
    @property
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.max_size
    def max_size(self):
        warnings.warn(
    ...
    @classmethod
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.from_dict with Detr->ConditionalDetr
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_annotation with DETR->ConditionalDetr
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.convert_coco_poly_to_mask
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_coco_detection with DETR->ConditionalDetr
    def prepare_coco_detection(self, *args, **kwargs):
        warnings.warn("The `prepare_coco_detection` method is deprecated and will be removed in a future version. ")
        return prepare_coco_detection_annotation(*args, **kwargs)

    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_coco_panoptic
    def prepare_coco_panoptic(self, *args, **kwargs):
        warnings.warn("The `prepare_coco_panoptic` method is deprecated and will be removed in a future version. ")
        return prepare_coco_panoptic_annotation(*args, **kwargs)

    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.resize_annotation
    def resize_annotation(
        self,
        annotation,
        orig_size,
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.rescale
    def rescale(
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.normalize
    def normalize(
        self,
        image: np.ndarray,
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.normalize_annotation
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.pad_and_create_pixel_mask
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor._pad_image
    def _pad_image(
        self,
        image: np.ndarray,
        output_size: Tuple[int, int],
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.pad
    def pad(
        self,
        images: List[np.ndarray],
        constant_values: Union[float, Iterable[float]] = 0,
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.preprocess
    def preprocess(
        self,
        images: ImageInput,
    ...
    # Copied from adapter_transformers.models.deformable_detr.image_processing_deformable_detr.DeformableDetrImageProcessor.post_process_object_detection with DeformableDetr->ConditionalDetr
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_semantic_segmentation with Detr->ConditionalDetr
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_instance_segmentation with Detr->ConditionalDetr
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_panoptic_segmentation with Detr->ConditionalDetr
