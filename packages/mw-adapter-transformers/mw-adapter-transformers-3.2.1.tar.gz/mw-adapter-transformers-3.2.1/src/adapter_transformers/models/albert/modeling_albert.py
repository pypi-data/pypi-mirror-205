...
class AlbertAttention(AlbertAttentionAdaptersMixin, nn.Module):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertSelfAttention.transpose_for_scores
...
class AlbertForPreTraining(AlbertModelWithHeadsAdaptersMixin, AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, AlbertForPreTraining
        >>> import torch
...
class AlbertForMaskedLM(AlbertModelWithHeadsAdaptersMixin, AlbertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import AutoTokenizer, AlbertForMaskedLM
