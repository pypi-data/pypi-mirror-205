...
# Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->XGLM
...
class TFXGLMDecoderLayer(tf.keras.layers.Layer):
    ...
    # Copied from adapter_transformers.models.mbart.modeling_tf_mbart.TFMBartDecoderLayer.call
    def call(
        self,
        hidden_states: tf.Tensor,
        attention_mask: Optional[tf.Tensor] = None,
