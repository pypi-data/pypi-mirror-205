...
from adapter_transformers.models.maskformer.feature_extraction_maskformer import MaskFormerFeatureExtractor
from adapter_transformers.models.maskformer.modeling_maskformer import (
    MaskFormerConfig,
