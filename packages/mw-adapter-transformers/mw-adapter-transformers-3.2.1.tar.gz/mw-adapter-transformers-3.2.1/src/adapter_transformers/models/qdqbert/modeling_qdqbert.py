...
# Copied from adapter_transformers.models.bert.modeling_bert.BertEmbeddings with Bert -> QDQBert
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertPooler with Bert -> QDQBert
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertPredictionHeadTransform with Bert -> QDQBert
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOnlyNSPHead with Bert -> QDQBert
...
class QDQBertLMHeadModel(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, QDQBertLMHeadModel, QDQBertConfig
        >>> import torch
...
class QDQBertForNextSentencePrediction(QDQBertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, QDQBertForNextSentencePrediction
        >>> import torch
