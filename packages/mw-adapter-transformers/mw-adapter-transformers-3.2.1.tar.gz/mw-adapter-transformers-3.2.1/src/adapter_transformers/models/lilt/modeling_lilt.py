...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfOutput
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOutput
...
class LiltLayer(nn.Module):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertLayer.feed_forward_chunk
...
class LiltEncoder(nn.Module):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertEncoder.__init__ with Bert->Lilt
    def __init__(self, config):
        super().__init__()
        self.config = config
...
# Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaPreTrainedModel with Roberta->Lilt,roberta->lilt
...
class LiltModel(LiltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, AutoModel
...
class LiltForSequenceClassification(LiltPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaForSequenceClassification.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, AutoModelForSequenceClassification
        >>> from datasets import load_dataset
...
class LiltForTokenClassification(LiltPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaForTokenClassification.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, AutoModelForTokenClassification
        >>> from datasets import load_dataset
...
# Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaClassificationHead with Roberta->Lilt
...
class LiltForQuestionAnswering(LiltPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaForQuestionAnswering.__init__ with Roberta->Lilt, roberta->lilt
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, AutoModelForQuestionAnswering
        >>> from datasets import load_dataset
