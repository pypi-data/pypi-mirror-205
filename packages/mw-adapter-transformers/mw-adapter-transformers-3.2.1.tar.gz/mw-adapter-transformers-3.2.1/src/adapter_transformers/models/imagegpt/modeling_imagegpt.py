...
class ImageGPTModel(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, ImageGPTModel
...
class ImageGPTForCausalImageModeling(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, ImageGPTForCausalImageModeling
        >>> import torch
...
class ImageGPTForImageClassification(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, ImageGPTForImageClassification
        >>> from PIL import Image
        >>> import requests
