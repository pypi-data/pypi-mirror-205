...
class FlavaImageConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaImageConfig, FlavaImageModel
...
class FlavaTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaTextConfig, FlavaTextModel
...
class FlavaMultimodalConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaMultimodalConfig, FlavaMultimodalModel
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaImageCodebookConfig, FlavaImageCodebook
...
class FlavaConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import FlavaConfig, FlavaModel, FlavaForPreTraining
