...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTSelfAttention with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTSelfOutput with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTAttention with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTIntermediate with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTOutput with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTLayer with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTEncoder with ViT->DeiT
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTPooler with ViT->DeiT
...
class DeiTForMaskedImageModeling(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DeiTForMaskedImageModeling
        >>> import torch
...
class DeiTForImageClassification(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DeiTForImageClassification
        >>> import torch
        >>> from PIL import Image
        >>> import requests
