...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->Marian
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartEncoderLayer with Bart->Marian
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->Marian
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartDecoderLayer with Bart->Marian
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->Marian
...
class FlaxMarianPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, FlaxMarianMTModel
