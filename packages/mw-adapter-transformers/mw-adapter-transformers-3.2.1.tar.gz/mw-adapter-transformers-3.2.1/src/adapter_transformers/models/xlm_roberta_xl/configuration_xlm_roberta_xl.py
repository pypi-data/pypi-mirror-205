...
class XLMRobertaXLConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import XLMRobertaXLConfig, XLMRobertaXLModel
...
# Copied from adapter_transformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRobertaXL
