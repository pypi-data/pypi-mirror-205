...
class CLIPTextModel(CLIPTextModelAdaptersMixin, CLIPPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, CLIPTextModel
...
class CLIPVisionModel(CLIPVisionModelAdaptersMixin, CLIPPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, CLIPVisionModel
...
class CLIPModel(CLIPModelAdaptersMixin, CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, CLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, CLIPModel
...
class CLIPTextModelWithProjection(CLIPTextModelAdaptersMixin, CLIPPreTrainedModel):
    config_class = CLIPTextConfig
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, CLIPTextModelWithProjection
...
class CLIPVisionModelWithProjection(CLIPVisionModelAdaptersMixin, CLIPPreTrainedModel):
    config_class = CLIPVisionConfig
    main_input_name = "pixel_values"
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, CLIPVisionModelWithProjection
