...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfAttention with Bert->Roberta
...
# Copied from adapter_transformers.models.modeling_bert.BertSelfOutput
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertAttention with Bert->Roberta
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertLayer with Bert->Roberta
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertEncoder with Bert->Roberta
...
class RobertaModel(BertModelAdaptersMixin, RobertaPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertModel.__init__ with Bert->Roberta
...
class RobertaForCausalLM(BertModelWithHeadsAdaptersMixin, RobertaPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RobertaForCausalLM, AutoConfig
        >>> import torch
