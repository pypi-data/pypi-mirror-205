...
# Copied from adapter_transformers.models.detr.image_processing_detr.prepare_coco_detection_annotation
...
# Copied from adapter_transformers.models.detr.image_processing_detr.prepare_coco_panoptic_annotation with DETR->YOLOS
...
class YolosImageProcessor(BaseImageProcessor):
    ...
    @classmethod
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.from_dict with Detr->Yolos
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_annotation
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_coco_detection with DETR->Yolos
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process  with Detr->Yolos
    ...
    # Copied from adapter_transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_object_detection with Detr->Yolos
