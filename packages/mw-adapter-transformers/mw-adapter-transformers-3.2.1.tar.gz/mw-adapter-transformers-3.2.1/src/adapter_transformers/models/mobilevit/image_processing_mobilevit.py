...
from adapter_transformers.utils import is_torch_available, is_torch_tensor, is_vision_available
from adapter_transformers.utils.generic import TensorType
