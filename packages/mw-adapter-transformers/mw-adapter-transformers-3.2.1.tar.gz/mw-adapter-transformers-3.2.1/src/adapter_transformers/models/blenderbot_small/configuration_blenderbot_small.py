...
class BlenderbotSmallConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import BlenderbotSmallConfig, BlenderbotSmallModel
...
# Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig
