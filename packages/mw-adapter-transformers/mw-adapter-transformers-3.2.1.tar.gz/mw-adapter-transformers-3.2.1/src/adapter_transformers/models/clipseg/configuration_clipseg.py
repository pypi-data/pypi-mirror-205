...
class CLIPSegTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import CLIPSegTextConfig, CLIPSegTextModel
...
class CLIPSegVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import CLIPSegVisionConfig, CLIPSegVisionModel
...
class CLIPSegConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import CLIPSegConfig, CLIPSegModel
