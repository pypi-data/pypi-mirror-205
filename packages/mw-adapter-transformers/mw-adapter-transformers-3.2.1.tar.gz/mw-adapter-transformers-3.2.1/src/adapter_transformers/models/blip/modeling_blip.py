...
# Copied from adapter_transformers.models.clip.modeling_clip.clip_loss with clip->blip
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->Blip
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPMLP with CLIP->Blip
...
class BlipModel(BlipPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, BlipModel
...
class BlipForConditionalGeneration(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, BlipForConditionalGeneration
...
class BlipForQuestionAnswering(BlipPreTrainedModel):
    ...
    # Adapted from adapter_transformers.models.t5.modeling_t5.T5PreTrainedModel._shift_right
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, BlipForQuestionAnswering
...
class BlipForImageTextRetrieval(BlipPreTrainedModel):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, BlipForImageTextRetrieval
