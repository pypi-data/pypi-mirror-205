...
# Copied from adapter_transformers.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBird->BigBirdPegasus
...
# Copied from adapter_transformers.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBird->BigBirdPegasus
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->BigBirdPegasusDecoder
...
class BigBirdPegasusDecoderLayer(nn.Module):
    ...
    # Copied from adapter_transformers.models.mbart.modeling_mbart.MBartDecoderLayer.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartClassificationHead with Bart->BigBirdPegasus
...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, BigBirdPegasusForConditionalGeneration
...
class BigBirdPegasusEncoder(BigBirdPegasusPreTrainedModel):
    ...
    @staticmethod  # Copied from adapter_transformers.models.big_bird.modeling_big_bird.BigBirdModel.create_masks_for_block_sparse_attn
...
class BigBirdPegasusDecoder(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bart.modeling_bart.BartDecoder._prepare_decoder_attention_mask
...
class BigBirdPegasusModel(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bart.modeling_bart.BartModel.forward with Bart->BigBirdPegasus
    def forward(
        self,
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForConditionalGeneration with Bart->BigBirdPegasus, BART->BIGBIRD_PEGASUS
...
class BigBirdPegasusForSequenceClassification(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bart.modeling_bart.BartForSequenceClassification.forward
    def forward(
        self,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
...
class BigBirdPegasusForQuestionAnswering(BigBirdPegasusPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bart.modeling_bart.BartForQuestionAnswering.forward
    def forward(
        self,
...
# Copied from adapter_transformers.models.pegasus.modeling_pegasus.PegasusDecoderWrapper with Pegasus->BigBirdPegasus
...
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, BigBirdPegasusForCausalLM
