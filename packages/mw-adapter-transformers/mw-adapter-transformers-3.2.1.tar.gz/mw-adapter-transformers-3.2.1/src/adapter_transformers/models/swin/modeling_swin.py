...
# Copied from adapter_transformers.models.beit.modeling_beit.BeitDropPath with Beit->Swin
...
class SwinForMaskedImageModeling(SwinPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoImageProcessor, SwinForMaskedImageModeling
        >>> import torch
