...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->PegasusX
...
PEGASUS_X_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, PegasusXForConditionalGeneration
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->PegasusX
