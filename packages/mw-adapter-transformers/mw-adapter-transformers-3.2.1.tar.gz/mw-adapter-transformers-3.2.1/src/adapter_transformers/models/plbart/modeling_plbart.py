...
# Copied from adapter_transformers.models.mbart.modeling_mbart.shift_tokens_right
...
# Copied from adapter_transformers.models.bart.modeling_bart._make_causal_mask
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartEncoderLayer with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderLayer with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartClassificationHead with Bart->PLBart
...
PLBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, PLBartForConditionalGeneration
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartEncoder with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoder with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->PLBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM with Bart->PLBart, facebook/bart-base->uclanlp/plbart-base
class PLBartForCausalLM(PLBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, PLBartForCausalLM
