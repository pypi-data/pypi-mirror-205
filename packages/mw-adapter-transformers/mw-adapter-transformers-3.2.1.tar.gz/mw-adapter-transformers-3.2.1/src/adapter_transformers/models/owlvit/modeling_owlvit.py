...
# Copied from adapter_transformers.models.clip.modeling_clip.contrastive_loss with clip->owlvit
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from adapter_transformers.models.clip.modeling_clip.clip_loss with clip->owlvit
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPMLP with CLIP->OwlViT
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->OwlViT
...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoProcessor, OwlViTTextModel
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoProcessor, OwlViTModel
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from adapter_transformers import AutoProcessor, OwlViTForObjectDetection
