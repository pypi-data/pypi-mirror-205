...
from adapter_transformers.activations import ACT2FN
from adapter_transformers.file_utils import (
    add_start_docstrings,
    add_start_docstrings_to_model_forward,
    replace_return_docstrings,
)
from adapter_transformers.modeling_outputs import (
...
from adapter_transformers.modeling_utils import (
    PreTrainedModel,
...
class MarkupLMEmbeddings(nn.Module):
    ...
    # Copied from adapter_transformers.models.roberta.modeling_roberta.RobertaEmbeddings.create_position_ids_from_inputs_embeds
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfOutput with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertIntermediate
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOutput with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertPredictionHeadTransform with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertLMPredictionHead with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertOnlyMLMHead with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfAttention with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertAttention with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertLayer with Bert->MarkupLM
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertEncoder with Bert->MarkupLM
...
class MarkupLMPreTrainedModel(PreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertPreTrainedModel._init_weights with Bert->MarkupLM
...
class MarkupLMModel(MarkupLMPreTrainedModel):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertModel.__init__ with Bert->MarkupLM
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, MarkupLMModel
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertModel.prepare_inputs_for_generation
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertModel._reorder_cache
...
class MarkupLMForQuestionAnswering(MarkupLMPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertForQuestionAnswering.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, MarkupLMForQuestionAnswering
        >>> import torch
...
class MarkupLMForTokenClassification(MarkupLMPreTrainedModel):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertForTokenClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, AutoModelForTokenClassification
        >>> import torch
...
class MarkupLMForSequenceClassification(MarkupLMPreTrainedModel):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertForSequenceClassification.__init__ with bert->markuplm, Bert->MarkupLM
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, AutoModelForSequenceClassification
        >>> import torch
