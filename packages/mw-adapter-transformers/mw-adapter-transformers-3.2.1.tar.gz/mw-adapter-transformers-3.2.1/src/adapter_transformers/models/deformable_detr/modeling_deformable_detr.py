...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrFrozenBatchNorm2d with Detr->DeformableDetr
...
# Copied from adapter_transformers.models.detr.modeling_detr.replace_batch_norm with Detr->DeformableDetr
...
class DeformableDetrConvEncoder(nn.Module):
    ...
    # Copied from adapter_transformers.models.detr.modeling_detr.DetrConvEncoder.forward with Detr->DeformableDetr
...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrConvModel with Detr->DeformableDetr
...
# Copied from adapter_transformers.models.detr.modeling_detr._expand_mask
...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrLearnedPositionEmbedding
...
# Copied from adapter_transformers.models.detr.modeling_detr.build_position_encoding with Detr->DeformableDetr
...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrClassificationHead
...
class DeformableDetrModel(DeformableDetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DeformableDetrModel
...
class DeformableDetrForObjectDetection(DeformableDetrPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, DeformableDetrForObjectDetection
        >>> from PIL import Image
        >>> import requests
...
class DeformableDetrLoss(nn.Module):
    ...
    @torch.no_grad()
    # Copied from adapter_transformers.models.detr.modeling_detr.DetrLoss.loss_cardinality
    ...
    # Copied from adapter_transformers.models.detr.modeling_detr.DetrLoss.loss_boxes
    ...
    # Copied from adapter_transformers.models.detr.modeling_detr.DetrLoss._get_source_permutation_idx
    ...
    # Copied from adapter_transformers.models.detr.modeling_detr.DetrLoss._get_target_permutation_idx
...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrMLPPredictionHead
