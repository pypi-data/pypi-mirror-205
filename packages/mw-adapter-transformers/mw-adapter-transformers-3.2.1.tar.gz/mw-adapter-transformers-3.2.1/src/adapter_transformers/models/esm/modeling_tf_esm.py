...
# Copied from adapter_transformers.models.bert.modeling_tf_bert.TFBertIntermediate with Bert->Esm
...
# Copied from adapter_transformers.models.bert.modeling_tf_bert.TFBertPooler with Bert->Esm
