...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartAttention with Bart->Blenderbot
...
# Copied from adapter_transformers.models.mbart.modeling_flax_mbart.FlaxMBartEncoderLayer with MBart->Blenderbot
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartEncoderLayerCollection with Bart->Blenderbot
...
# Copied from adapter_transformers.models.mbart.modeling_flax_mbart.FlaxMBartDecoderLayer with MBart->Blenderbot
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartDecoderLayerCollection with Bart->Blenderbot
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartModule with Bart->Blenderbot
...
class FlaxBlenderbotPreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, FlaxBlenderbotForConditionalGeneration
...
# Copied from adapter_transformers.models.bart.modeling_flax_bart.FlaxBartForConditionalGenerationModule with Bart->Blenderbot
