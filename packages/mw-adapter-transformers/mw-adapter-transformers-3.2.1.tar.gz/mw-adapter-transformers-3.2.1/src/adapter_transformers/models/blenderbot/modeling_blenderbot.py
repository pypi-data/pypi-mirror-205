...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->Blenderbot
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Blenderbot
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Blenderbot
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, BlenderbotForConditionalGeneration
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, BlenderbotModel
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->Blenderbot
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM with Bart->Blenderbot, facebook/bart-base->facebook/blenderbot-400M-distill
class BlenderbotForCausalLM(BlenderbotPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, BlenderbotForCausalLM
