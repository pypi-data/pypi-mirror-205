...
from adapter_transformers.utils.logging import tqdm
...
old_default_cache_path = os.path.join(torch_cache_home, "adapter_transformers")
...
TRANSFORMERS_DYNAMIC_MODULE_NAME = "adapter_transformers_modules"
...
def http_user_agent(user_agent: Union[Dict, str, None] = None) -> str:
    ...
    """
    ua = f"adapter_transformers/{__version__}; python/{sys.version.split()[0]}; session_id/{SESSION_ID}"
...
class PushToHubMixin:
    ...
    def push_to_hub(
        ...
        **deprecated_kwargs
        ...
        ```python
        from adapter_transformers import {object_class}
...
def move_cache(cache_dir=None, new_cache_dir=None, token=None):
    ...
    if cache_dir is None:
        ...
        old_cache = Path(TRANSFORMERS_CACHE).parent / "adapter_transformers"
