...
from adapter_transformers.image_utils import ChannelDimension, ImageInput, PILImageResampling, is_batched, valid_images
from adapter_transformers.utils import TensorType, is_torch_available, logging
