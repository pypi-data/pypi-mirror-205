...
from adapter_transformers.tf_utils import shape_list, stable_softmax
...
# Copied from adapter_transformers.models.vit.modeling_tf_vit.TFViTIntermediate with ViT->Data2VecVision
...
class TFData2VecVisionForSemanticSegmentation(TFData2VecVisionPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, TFData2VecVisionForSemanticSegmentation
