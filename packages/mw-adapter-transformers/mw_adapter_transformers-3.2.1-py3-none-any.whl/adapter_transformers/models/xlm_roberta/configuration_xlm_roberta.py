...
class XLMRobertaConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import XLMRobertaConfig, XLMRobertaModel
...
# Copied from adapter_transformers.models.roberta.configuration_roberta.RobertaOnnxConfig with Roberta->XLMRoberta
