...
# Copied from adapter_transformers.models.longformer.modeling_tf_longformer.TFLongformerSelfAttention with TFLongformer->TFLEDEncoder
...
@dataclass
# Copied from adapter_transformers.models.longformer.modeling_tf_longformer.TFLongformerBaseModelOutput with TFLongformer->TFLEDEncoder
...
class TFLEDForConditionalGeneration(TFLEDPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, TFLEDForConditionalGeneration
        >>> import tensorflow as tf
