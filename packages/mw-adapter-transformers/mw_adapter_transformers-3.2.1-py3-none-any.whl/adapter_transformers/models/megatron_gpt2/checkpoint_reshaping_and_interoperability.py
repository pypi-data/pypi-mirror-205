...
from adapter_transformers import AutoTokenizer, GPT2Config
from adapter_transformers.modeling_utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME, shard_checkpoint
...
def merge_transformers_sharded_states(path, num_checkpoints):
    """
    Merge sharded checkpoints from adapter_transformers into a single checkpoint.
