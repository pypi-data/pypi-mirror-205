...
# Copied from adapter_transformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MVP
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartClassificationHead with Bart->MVP
...
MVP_CONDITIONAL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import AutoTokenizer, MvpForConditionalGeneration
...
MVP_SEQUENCE_CLASSIFICATION_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import AutoTokenizer, MvpForSequenceClassification
...
MVP_QUESTION_ANSWERING_SAMPLE = r"""
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers import AutoTokenizer, MvpForQuestionAnswering
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->Mvp
...
class MvpForCausalLM(MvpPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, MvpForCausalLM
