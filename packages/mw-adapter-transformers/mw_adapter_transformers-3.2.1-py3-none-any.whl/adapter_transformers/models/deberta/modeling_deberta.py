...
class XSoftmax(torch.autograd.Function):
    ...
    ```python
    >>> import torch
    >>> from adapter_transformers.models.deberta.modeling_deberta import XSoftmax
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertIntermediate with Bert->Deberta
