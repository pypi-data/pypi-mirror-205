...
# Copied from adapter_transformers.models.encoder_decoder.modeling_tf_encoder_decoder.shift_tokens_right
...
class TFVisionEncoderDecoderModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from adapter_transformers import TFVisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
        ...
        if from_pt:
            ...
            from adapter_transformers import VisionEncoderDecoderModel
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import TFVisionEncoderDecoderModel
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, AutoTokenizer, TFVisionEncoderDecoderModel
        >>> from PIL import Image
        >>> import requests
