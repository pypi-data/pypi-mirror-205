...
# Copied from adapter_transformers.models.encoder_decoder.modeling_encoder_decoder.shift_tokens_right
...
class VisionEncoderDecoderModel(PreTrainedModel):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from adapter_transformers import VisionEncoderDecoderModel, AutoImageProcessor, AutoTokenizer
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, VisionEncoderDecoderModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch
