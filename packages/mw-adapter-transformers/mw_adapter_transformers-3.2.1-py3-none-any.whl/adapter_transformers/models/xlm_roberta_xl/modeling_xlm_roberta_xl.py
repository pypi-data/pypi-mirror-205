...
# Copied from adapter_transformers.models.bert.modeling_bert.BertSelfAttention with Bert->XLMRobertaXL
...
class XLMRobertaXLModel(XLMRobertaXLPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bert.modeling_bert.BertModel.__init__ with Bert->XLMRobertaXL
...
class XLMRobertaXLForCausalLM(XLMRobertaXLPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RobertaForCausalLM, RobertaConfig
        >>> import torch
