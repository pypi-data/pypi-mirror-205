...
@dataclass
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPVisionModelOutput with CLIP->Git
...
class GitAttention(nn.Module):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertAttention.__init__ with Bert->Git
    def __init__(self, config, position_embedding_type=None):
        super().__init__()
...
class GitEncoder(nn.Module):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertEncoder.__init__ with Bert->Git
    def __init__(self, config):
        super().__init__()
        self.config = config
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Git
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPMLP
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPAttention
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPEncoderLayer with CLIP->GitVision
...
# Copied from adapter_transformers.models.clip.modeling_clip.CLIPEncoder with CLIP->GitVision, CLIPConfig
...
class GitVisionTransformer(nn.Module):
    # Copied from adapter_transformers.models.clip.modeling_clip.CLIPVisionTransformer.__init__ with CLIPEncoder->GitVisionEncoder, CLIP->Git
    def __init__(self, config: GitVisionConfig):
        super().__init__()
        self.config = config
...
class GitVisionModel(GitPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP->Git
    def __init__(self, config: GitVisionConfig):
    ...
    def forward(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, GitVisionModel
...
class GitModel(GitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, AutoModel
        >>> import requests
        >>> from PIL import Image
...
class GitForCausalLM(GitPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoProcessor, AutoModelForCausalLM
        >>> import requests
        >>> from PIL import Image
