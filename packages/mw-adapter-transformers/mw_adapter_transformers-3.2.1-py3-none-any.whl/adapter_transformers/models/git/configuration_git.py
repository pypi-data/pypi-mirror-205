...
# Copied from adapter_transformers.models.clip.configuration_clip.CLIPVisionConfig with CLIPVision->GitVision, CLIP->GIT, clip->git, openai/git-vit-base-patch32->microsoft/git-base, 32->16
class GitVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import GitVisionConfig, GitVisionModel
...
class GitConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import GitConfig, GitModel
