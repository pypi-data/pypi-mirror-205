...
from adapter_transformers import AutoBackbone, SwinConfig
...
# Copied from adapter_transformers.models.maskformer.modeling_maskformer.MaskFormerSinePositionEmbedding with MaskFormer->Mask2Former
...
# Modified from adapter_transformers.models.detr.modeling_deformable_detr.DeformableDetrMultiscaleDeformableAttention
...
# Modified from from adapter_transformers.models.detr.modeling_deformable_detr.DeformableDetrEncoder with DeformableDetrEncoder->Mask2FormerPixelDecoderEncoderOnly
...
# Modified from from adapter_transformers.models.detr.modeling_deformable_detr.DeformableDetrModel with DeformableDetrModel->Mask2FormerPixelDecoder
...
# Modified from adapter_transformers.models.detr.modeling_detr.DetrAttention with Detr->Mask2Former
...
# Copied from adapter_transformers.models.maskformer.modeling_maskformer.PredictionBlock with MaskFormer->Mask2Former
...
class Mask2FormerModel(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoImageProcessor, Mask2FormerModel
...
class Mask2FormerForUniversalSegmentation(Mask2FormerPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoImageProcessor, Mask2FormerForUniversalSegmentation
        >>> from PIL import Image
        >>> import requests
        >>> import torch
