...
from adapter_transformers import AutoFeatureExtractor, VanConfig, VanForImageClassification
from adapter_transformers.models.van.modeling_van import VanLayerScaling
