...
class RagPreTrainedModel(PreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import RagModel
...
class RagModel(RagPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, RagModel
        >>> import torch
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, RagSequenceForGeneration
        >>> import torch
...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, RagTokenForGeneration
        >>> import torch
