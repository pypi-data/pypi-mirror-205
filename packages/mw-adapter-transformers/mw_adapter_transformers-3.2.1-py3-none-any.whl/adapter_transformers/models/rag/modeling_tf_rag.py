...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, TFRagModel
        >>> import torch
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs  # needs kwargs for generation
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration
