...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTSelfOutput with ViT->Vilt
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTIntermediate with ViT->Vilt
...
# Copied from adapter_transformers.models.vit.modeling_vit.ViTOutput with ViT->Vilt
...
class ViltModel(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import ViltProcessor, ViltModel
...
class ViltForMaskedLM(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import ViltProcessor, ViltForMaskedLM
        >>> import requests
        >>> from PIL import Image
        >>> import re
        >>> import torch
...
class ViltForQuestionAnswering(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import ViltProcessor, ViltForQuestionAnswering
        >>> import requests
        >>> from PIL import Image
...
class ViltForImageAndTextRetrieval(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import ViltProcessor, ViltForImageAndTextRetrieval
        >>> import requests
        >>> from PIL import Image
...
class ViltForImagesAndTextClassification(ViltPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import ViltProcessor, ViltForImagesAndTextClassification
        >>> import requests
        >>> from PIL import Image
