...
# Copied from adapter_transformers.models.marian.modeling_marian.MarianSinusoidalPositionalEmbedding with Marian->Pegasus
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->Pegasus
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->Pegasus
...
# Copied from adapter_transformers.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->Pegasus
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, PegasusForConditionalGeneration
...
class PegasusModel(PegasusPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, PegasusModel
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->Pegasus
...
class PegasusForCausalLM(PegasusPreTrainedModel):
    ...
    # Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM.forward with Bart->Pegasus, facebook/bart-base->google/pegasus-large
    def forward(
        self,
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, PegasusForCausalLM
