...
from adapter_transformers import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from adapter_transformers.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
