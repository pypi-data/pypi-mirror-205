...
# Copied from adapter_transformers.models.bart.modeling_bart.BartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->MBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartClassificationHead with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, MBartForConditionalGeneration
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->MBart
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM with Bart->MBart, facebook/bart-base->facebook/mbart-large-cc25
class MBartForCausalLM(BartModelWithHeadsAdaptersMixin, MBartPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, MBartForCausalLM
