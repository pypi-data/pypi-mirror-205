...
# Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartLearnedPositionalEmbedding with Bart->MBart
...
# Copied from adapter_transformers.models.bart.modeling_tf_bart.TFBartAttention with Bart->MBart
...
MBART_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, TFMBartForConditionalGeneration, MBartConfig
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, TFMBartForConditionalGeneration
