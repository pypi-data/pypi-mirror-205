...
FLAX_BEIT_MODEL_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import AutoImageProcessor, FlaxBeitModel
...
FLAX_BEIT_MLM_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import AutoImageProcessor, BeitForMaskedImageModeling
    >>> from PIL import Image
    >>> import requests
...
FLAX_BEIT_CLASSIF_DOCSTRING = """
    ...
    ```python
    >>> from adapter_transformers import AutoImageProcessor, FlaxBeitForImageClassification
    >>> from PIL import Image
    >>> import requests
