...
class TableTransformerConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import TableTransformerModel, TableTransformerConfig
    ...
    # Copied from adapter_transformers.models.detr.configuration_detr.DetrConfig.__init__
    def __init__(
        self,
        use_timm_backbone=True,
...
# Copied from adapter_transformers.models.detr.configuration_detr.DetrOnnxConfig
