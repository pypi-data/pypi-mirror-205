...
class AlbertConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import AlbertConfig, AlbertModel
...
# Copied from adapter_transformers.models.bert.configuration_bert.BertOnnxConfig with Roberta->Albert
