...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->TimeSeriesTransformer
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartEncoderLayer with Bart->TimeSeriesTransformer
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderLayer with Bart->TimeSeriesTransformer
...
class TimeSeriesTransformerModel(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> import torch
        >>> from adapter_transformers import TimeSeriesTransformerModel
...
class TimeSeriesTransformerForPrediction(TimeSeriesTransformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from huggingface_hub import hf_hub_download
        >>> import torch
        >>> from adapter_transformers import TimeSeriesTransformerForPrediction
