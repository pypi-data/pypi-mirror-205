...
class MobileBertConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import MobileBertConfig, MobileBertModel
...
# Copied from adapter_transformers.models.bert.configuration_bert.BertOnnxConfig with Bert->MobileBert
