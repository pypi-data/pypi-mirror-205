...
# Copied from adapter_transformers.models.bart.modeling_bart.shift_tokens_right
...
# Copied from adapter_transformers.models.blenderbot.modeling_blenderbot.BlenderbotLearnedPositionalEmbedding with Blenderbot->BlenderbotSmall
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->BlenderbotSmall
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartEncoderLayer with Bart->BlenderbotSmall
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderLayer with Bart->BlenderbotSmall
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    ...
    ```python
    >>> from adapter_transformers import AutoTokenizer, BlenderbotSmallForConditionalGeneration
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, BlenderbotSmallModel
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartDecoderWrapper with Bart->BlenderbotSmall
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM with Bart->BlenderbotSmall, facebook/bart-base->facebook/blenderbot_small-90M
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, BlenderbotSmallForCausalLM
