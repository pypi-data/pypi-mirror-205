...
# Copied from adapter_transformers.models.gpt_neox.modeling_gpt_neox.RotaryEmbedding
...
class GPTNeoXJapaneseModel(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, GPTNeoXJapaneseModel
        >>> import torch
...
class GPTNeoXJapaneseForCausalLM(GPTNeoXJapanesePreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, GPTNeoXJapaneseForCausalLM, GPTNeoXJapaneseConfig
        >>> import torch
