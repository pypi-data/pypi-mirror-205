...
from adapter_transformers import ViTFeatureExtractor, ViTMSNConfig, ViTMSNModel
from adapter_transformers.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
