...
# Copied from adapter_transformers.models.bart.modeling_bart.BartAttention with Bart->Wav2Vec2
...
class Wav2Vec2ForPreTraining(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> import torch
        >>> from adapter_transformers import AutoFeatureExtractor, Wav2Vec2ForPreTraining
        >>> from adapter_transformers.models.wav2vec2.modeling_wav2vec2 import _compute_mask_indices, _sample_negative_indices
