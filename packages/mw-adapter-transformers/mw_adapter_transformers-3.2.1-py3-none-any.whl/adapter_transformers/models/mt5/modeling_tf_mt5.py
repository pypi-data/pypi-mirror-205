...
class TFMT5Model(TFT5Model):
    ...
    ```python
    >>> from adapter_transformers import TFMT5Model, AutoTokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    ```python
    >>> from adapter_transformers import TFMT5ForConditionalGeneration, AutoTokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    ```python
    >>> from adapter_transformers import TFMT5EncoderModel, AutoTokenizer
