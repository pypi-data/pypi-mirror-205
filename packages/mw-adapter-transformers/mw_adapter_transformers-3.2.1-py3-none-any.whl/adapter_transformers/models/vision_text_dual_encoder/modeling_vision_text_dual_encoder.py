...
# Copied from adapter_transformers.models.clip.modeling_clip.clip_loss
...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import VisionTextDualEncoderModel, AutoTokenizer
    ...
    def get_image_features(
        ...
        >>> import requests
        >>> from adapter_transformers import VisionTextDualEncoderModel, AutoImageProcessor
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from adapter_transformers import VisionTextDualEncoderModel
