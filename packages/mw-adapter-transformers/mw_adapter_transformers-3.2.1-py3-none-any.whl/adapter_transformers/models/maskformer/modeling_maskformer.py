...
@dataclass
# Copied from adapter_transformers.models.detr.modeling_detr.DetrDecoderOutput
...
# Copied from adapter_transformers.models.detr.modeling_detr.DetrDecoderLayer
...
class MaskFormerModel(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, MaskFormerModel
...
class MaskFormerForInstanceSegmentation(MaskFormerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, MaskFormerForInstanceSegmentation
        >>> from PIL import Image
        >>> import requests
