...
# Copied from adapter_transformers.models.beit.modeling_beit.BeitDropPath with Beit->TimeSformer
...
class TimesformerModel(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from adapter_transformers import AutoFeatureExtractor, TimesformerModel
...
class TimesformerForVideoClassification(TimesformerPreTrainedModel):
    ...
    def forward(
        ...
        >>> from adapter_transformers import AutoFeatureExtractor, TimesformerForVideoClassification
        >>> from huggingface_hub import hf_hub_download
