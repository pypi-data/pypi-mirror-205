...
from adapter_transformers import shape_list
...
class TFConvNextModel(TFConvNextPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, TFConvNextModel
...
class TFConvNextForImageClassification(TFConvNextPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, TFConvNextForImageClassification
        >>> import tensorflow as tf
        >>> from PIL import Image
        >>> import requests
