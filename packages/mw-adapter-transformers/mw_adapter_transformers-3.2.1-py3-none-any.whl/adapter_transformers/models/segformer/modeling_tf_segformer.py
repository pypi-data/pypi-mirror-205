...
# Copied from adapter_transformers.models.convnext.modeling_tf_convnext.TFConvNextDropPath with ConvNext->Segformer
...
class TFSegformerForSemanticSegmentation(TFSegformerPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, TFSegformerForSemanticSegmentation
