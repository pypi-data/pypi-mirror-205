...
# Copied from adapter_transformers.models.convnext.modeling_convnext.drop_path
...
# Copied from adapter_transformers.models.convnext.modeling_convnext.ConvNextDropPath with ConvNext->Segformer
...
class SegformerForSemanticSegmentation(SegformerPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, SegformerForSemanticSegmentation
