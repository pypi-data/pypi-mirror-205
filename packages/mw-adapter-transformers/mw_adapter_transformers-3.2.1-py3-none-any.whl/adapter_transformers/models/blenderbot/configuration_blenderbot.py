...
class BlenderbotConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import BlenderbotConfig, BlenderbotModel
...
class BlenderbotOnnxConfig(OnnxSeq2SeqConfigWithPast):
    ...
    @property
    # Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig.outputs
    ...
    # Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig._generate_dummy_inputs_for_sequence_classification_and_question_answering
    ...
    # Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig.generate_dummy_inputs
    ...
    # Copied from adapter_transformers.models.bart.configuration_bart.BartOnnxConfig._flatten_past_key_values_
