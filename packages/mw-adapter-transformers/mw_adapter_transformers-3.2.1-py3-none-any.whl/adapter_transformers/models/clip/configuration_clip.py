...
class CLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import CLIPTextConfig, CLIPTextModel
...
class CLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import CLIPVisionConfig, CLIPVisionModel
...
class CLIPConfig(PretrainedConfig):
    ...
    >>> from adapter_transformers import CLIPTextConfig, CLIPVisionConfig
