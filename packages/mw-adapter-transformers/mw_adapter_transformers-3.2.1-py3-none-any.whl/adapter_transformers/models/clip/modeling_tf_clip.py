...
class TFCLIPTextModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, TFCLIPTextModel
...
class TFCLIPVisionModel(TFCLIPPreTrainedModel):
    ...
    def call(
        ...
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, TFCLIPVisionModel
...
class TFCLIPModel(TFCLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, TFCLIPModel
    ...
    def get_image_features(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from adapter_transformers import AutoProcessor, TFCLIPModel
