...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import AltCLIPConfig, AltCLIPModel
