...
class BlipTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import BlipTextConfig, BlipTextModel
...
class BlipVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import BlipVisionConfig, BlipVisionModel
...
class BlipConfig(PretrainedConfig):
    ...
    ```python
    >>> from adapter_transformers import BlipConfig, BlipModel
