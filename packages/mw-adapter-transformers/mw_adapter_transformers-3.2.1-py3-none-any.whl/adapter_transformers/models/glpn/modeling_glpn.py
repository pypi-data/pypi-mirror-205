...
# Copied from adapter_transformers.models.segformer.modeling_segformer.drop_path
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerDropPath
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerOverlapPatchEmbeddings
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerEfficientSelfAttention
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerSelfOutput
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerAttention with Segformer->GLPN
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerDWConv
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerMixFFN with Segformer->GLPN
...
# Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerLayer with Segformer->GLPN
...
class GLPNPreTrainedModel(PreTrainedModel):
    ...
    # Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerPreTrainedModel._init_weights
...
class GLPNModel(GLPNPreTrainedModel):
    # Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerModel.__init__ with Segformer->GLPN
    def __init__(self, config):
    ...
    # Copied from adapter_transformers.models.segformer.modeling_segformer.SegformerModel.forward
    def forward(
        self,
...
class GLPNForDepthEstimation(GLPNPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoImageProcessor, GLPNForDepthEstimation
        >>> import torch
        >>> import numpy as np
