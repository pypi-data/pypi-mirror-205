...
from adapter_transformers.modeling_utils import dtype_byte_size
from adapter_transformers.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from adapter_transformers.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from adapter_transformers.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from adapter_transformers import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer
