...
# Copied from adapter_transformers.models.t5.modeling_t5.T5LayerNorm with T5->SwitchTransformers
...
# Copied from adapter_transformers.models.t5.modeling_t5.T5DenseActDense with T5->SwitchTransformers
...
# Copied from adapter_transformers.models.longt5.modeling_longt5.LongT5DenseGatedActDense with LongT5->SwitchTransformers
...
# Copied from adapter_transformers.models.t5.modeling_t5.T5Attention with T5->SwitchTransformers
...
# Copied from adapter_transformers.models.t5.modeling_t5.T5LayerSelfAttention with T5->SwitchTransformers
...
# Copied from adapter_transformers.models.t5.modeling_t5.T5LayerCrossAttention with T5->SwitchTransformers
...
class SwitchTransformersModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, SwitchTransformersModel
...
class SwitchTransformersForConditionalGeneration(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, SwitchTransformersForConditionalGeneration
...
class SwitchTransformersEncoderModel(SwitchTransformersPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from adapter_transformers import AutoTokenizer, SwitchTransformersEncoderModel
