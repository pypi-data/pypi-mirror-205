...
@dataclass
# Copied from adapter_transformers.models.swin.modeling_swin.SwinEncoderOutput with Swin->Swinv2
...
@dataclass
# Copied from adapter_transformers.models.swin.modeling_swin.SwinModelOutput with Swin->Swinv2
...
@dataclass
# Copied from adapter_transformers.models.swin.modeling_swin.SwinMaskedImageModelingOutput with Swin->Swinv2
...
@dataclass
# Copied from adapter_transformers.models.swin.modeling_swin.SwinImageClassifierOutput with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.window_partition
...
# Copied from adapter_transformers.models.swin.modeling_swin.window_reverse
...
# Copied from adapter_transformers.models.swin.modeling_swin.drop_path
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinDropPath with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinEmbeddings with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinPatchEmbeddings with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinSelfOutput with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinIntermediate with Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinOutput with Swin->Swinv2
...
class Swinv2Stage(nn.Module):
    ...
    # Copied from adapter_transformers.models.swin.modeling_swin.SwinStage.forward
    def forward(
        self,
        hidden_states: torch.Tensor,
        input_dimensions: Tuple[int, int],
...
class Swinv2Encoder(nn.Module):
    ...
    # Copied from adapter_transformers.models.swin.modeling_swin.SwinEncoder.forward with SwinEncoderOutput->Swinv2EncoderOutput
    def forward(
        self,
        hidden_states: torch.Tensor,
        input_dimensions: Tuple[int, int],
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinPreTrainedModel with Swin->Swinv2,swin->swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinModel with SWIN->SWINV2,Swin->Swinv2
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinForMaskedImageModeling with swin->swinv2, base-simmim-window6-192->tiny-patch4-window8-256,SWIN->SWINV2,Swin->Swinv2,192->256
class Swinv2ForMaskedImageModeling(Swinv2PreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from adapter_transformers import AutoImageProcessor, Swinv2ForMaskedImageModeling
        >>> import torch
...
# Copied from adapter_transformers.models.swin.modeling_swin.SwinForImageClassification with SWIN->SWINV2,Swin->Swinv2,swin->swinv2
