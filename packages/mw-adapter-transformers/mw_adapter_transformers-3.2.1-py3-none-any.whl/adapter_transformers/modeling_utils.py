...
from adapter_transformers.utils.hub import convert_file_size_to_int, get_checkpoint_shard_files
from adapter_transformers.utils.import_utils import ENV_VARS_TRUE_VALUES, is_sagemaker_mp_enabled
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        ```python
        >>> from adapter_transformers import BertConfig, BertModel
    ...
    def register_for_auto_class(cls, auto_class="AutoModel"):
        ...
        import adapter_transformers.models.auto as auto_module
