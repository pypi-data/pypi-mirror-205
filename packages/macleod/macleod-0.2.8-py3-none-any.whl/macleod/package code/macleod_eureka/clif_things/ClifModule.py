...
import macleod_eureka.Process as process
import macleod_eureka.clif_things.Clif as clif
import macleod_eureka.Commands as commands
import macleod_eureka.lang.Ladr as ladr
...
class ClifModule(object):
    ...
    def get_module_set (self, imports = None):
        ...
        from macleod_eureka.clif_things.ClifLemmaSet import LemmaModule
