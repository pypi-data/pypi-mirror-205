...
def remove_node(
    ...
    ** Deletes a node from the graph. **
    ...
    graph.remove_edges_from(transformations)
    transformations = {**transformations, **remove_edges(graph, graph.out_edges(node, keys=True))}
...
def remove_nodes(
    ...
    ** Deletes several nodes from the graph. **
    ...
    transformations = {**transformations, **remove_edges(graph, edges)}
    transformations = {**transformations, **{node: None for node in nodes}}
