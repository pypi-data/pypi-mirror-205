...
class fig_density_z(object):
    ...
    def __init__(self, ax, settings):
        ...
        self.line_density_z, = ax.plot(settings.z, zeros_like(settings.z), linewidth=1, linestyle='-',
                                          color=colors.wet_asphalt, label=r'$|\psi(x_1, 0, z)|^2$')
        ...
        self.line_V_z, = ax_V_z.plot(settings.z, zeros_like(settings.z), linewidth=1, linestyle='-',
        ...
        ax_V_z.legend(loc='upper right', bbox_to_anchor=(1.0, 1.0), fancybox=False, framealpha=1.0, ncol=1)
