...
class fig_spectrum_abs_xy_mask_tof_gpe(object):
    ...
    def __init__(self, ax, settings):
        ...
        spectrum_abs_xy_mask_tof_gpe = np.zeros((settings.Jx_tof_gpe, settings.Jy_tof_gpe))
        ...
        self.image_spectrum_abs_xy_mask_tof_gpe = ax.imshow(
            np.transpose(spectrum_abs_xy_mask_tof_gpe),
    ...
    def update(self, spectrum_abs_xy_mask_tof_gpe):

        self.image_spectrum_abs_xy_mask_tof_gpe.set_data(np.transpose(spectrum_abs_xy_mask_tof_gpe))
