...
class fig_density_xy_tof_gpe(object):
    ...
    def __init__(self, ax, settings):
        ...
        density_xy_tof_gpe = np.zeros((settings.Jx_tof_gpe, settings.Jy_tof_gpe))
        ...
        self.image_density_xy_tof_gpe = ax.imshow(
            np.transpose(density_xy_tof_gpe),
    ...
    def update(self, density_xy_tof_gpe):

        self.image_density_xy_tof_gpe.set_data(np.transpose(density_xy_tof_gpe))
