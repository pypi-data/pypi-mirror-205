...
import malariagen.cloud
from malariagen.cloud import Af1, Ag3


def test_version():
    assert hasattr(malariagen.cloud, "__version__")
    assert isinstance(malariagen.cloud.__version__, str)
    version = parse(malariagen.cloud.__version__)
