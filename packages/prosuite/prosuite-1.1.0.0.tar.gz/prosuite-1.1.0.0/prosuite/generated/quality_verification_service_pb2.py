...
_DATAVERIFICATIONREQUEST = DESCRIPTOR.message_types_by_name['DataVerificationRequest']
_STANDALONEVERIFICATIONREQUEST = DESCRIPTOR.message_types_by_name['StandaloneVerificationRequest']
_VERIFICATIONRESPONSE = DESCRIPTOR.message_types_by_name['VerificationResponse']
_DATAVERIFICATIONRESPONSE = DESCRIPTOR.message_types_by_name['DataVerificationResponse']
_STANDALONEVERIFICATIONRESPONSE = DESCRIPTOR.message_types_by_name['StandaloneVerificationResponse']
VerificationRequest = _reflection.GeneratedProtocolMessageType('VerificationRequest', (_message.Message,), {
  ...
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.VerificationRequest)
  })
_sym_db.RegisterMessage(VerificationRequest)

DataVerificationRequest = _reflection.GeneratedProtocolMessageType('DataVerificationRequest', (_message.Message,), {
  'DESCRIPTOR' : _DATAVERIFICATIONREQUEST,
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.DataVerificationRequest)
  })
_sym_db.RegisterMessage(DataVerificationRequest)

StandaloneVerificationRequest = _reflection.GeneratedProtocolMessageType('StandaloneVerificationRequest', (_message.Message,), {
  'DESCRIPTOR' : _STANDALONEVERIFICATIONREQUEST,
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.StandaloneVerificationRequest)
  })
_sym_db.RegisterMessage(StandaloneVerificationRequest)
...
VerificationResponse = _reflection.GeneratedProtocolMessageType('VerificationResponse', (_message.Message,), {
  ...
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.VerificationResponse)
  })
_sym_db.RegisterMessage(VerificationResponse)

DataVerificationResponse = _reflection.GeneratedProtocolMessageType('DataVerificationResponse', (_message.Message,), {
  'DESCRIPTOR' : _DATAVERIFICATIONRESPONSE,
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.DataVerificationResponse)
  })
_sym_db.RegisterMessage(DataVerificationResponse)

StandaloneVerificationResponse = _reflection.GeneratedProtocolMessageType('StandaloneVerificationResponse', (_message.Message,), {
  'DESCRIPTOR' : _STANDALONEVERIFICATIONRESPONSE,
  '__module__' : 'quality_verification_service_pb2'
  # @@protoc_insertion_point(class_scope:ProSuite.Microservices.Definitions.QA.StandaloneVerificationResponse)
  })
_sym_db.RegisterMessage(StandaloneVerificationResponse)

_QUALITYVERIFICATIONGRPC = DESCRIPTOR.services_by_name['QualityVerificationGrpc']
