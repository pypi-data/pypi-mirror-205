...
from Shared.certoraUtils import get_certora_internal_dir, is_new_api, PRODUCTION_DOMAIN, STAGING_DOMAIN
...
class CloudVerification:
    ...
    def print_output_links(self) -> None:
        if self.context.staging:
            print(f"Follow your job at {STAGING_DOMAIN}")
            print(f"If the job does yet appear at the dashboard, follow it here {self.statusUrl}")
        else:
            print(f"Follow your job at {PRODUCTION_DOMAIN}")
