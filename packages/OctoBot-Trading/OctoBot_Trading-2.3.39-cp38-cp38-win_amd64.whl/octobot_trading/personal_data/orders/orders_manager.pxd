...
cdef class OrdersManager(util.Initializable):
    ...
    cdef list _select_orders(self, object state=*, str symbol=*, int since=*, int until=*, int limit=*, str tag=*)
    ...
    cpdef list get_all_orders(self, str symbol=*, int since=*, int until=*, int limit=*, str tag=*)
    cpdef list get_open_orders(self, str symbol=*, int since=*, int until=*, int limit=*, str tag=*)
    cpdef list get_pending_cancel_orders(self, str symbol=*, int since=*, int until=*, int limit=*, str tag=*)
    cpdef list get_closed_orders(self, str symbol=*, int since=*, int until=*, int limit=*, str tag=*)
