...
cdef class HistoricalPortfolioValueManager(util.Initializable):
    ...
    cdef set _get_relevant_timestamps(self, double timestamp, object value_by_currency, list time_frames, bint force_update, bint include_past_data)
    cdef bint _should_update_timestamp(self, object value_by_currency, object time_frame_allowed_window_start, bint force_update)
