...
with pytest.raises(rc.SchedulingEvaluateCalledWithSymsError) as exc:
    sym.evaluate()
print(exc.exconly())
...
'a.norm' Module
  ...
  'a.norm.input' [?,?] Symbol 6a622698-fd68-4d25-aeee-e8d38e68049e ! 'ln.input'
  'a.ln.w.bias' [?] Symbol 2c737289-2702-404c-a22e-ad37c2652620 ! 'ln.w.bias'
  'a.ln.w.scale' [?] Symbol c564149d-e226-4e3d-8e47-7d6e2ceea99e ! 'ln.w.scale'
"""
a_norm = P(s)
...
'a.norm' Module
  'w.a.ln' Add
    'a.ln.w.bias' [?] Symbol 2c737289-2702-404c-a22e-ad37c2652620
        ...
        'ln.rsqrt' GeneralFunction rsqrt
          'ln.var_p_eps' Add
            ...
            'ln.var' Einsum h,h,->
              ...
              'ln.mean_subbed'
              'ln.c.recip_hidden_size'
      'a.ln.w.scale' [?] Symbol c564149d-e226-4e3d-8e47-7d6e2ceea99e
  'a.norm.input' [?,?] Symbol 6a622698-fd68-4d25-aeee-e8d38e68049e ! 'ln.input'
"""
...
s_with_sym = """
0 Einsum ij,jk->ik
  1 [?,?] Symbol 6594dafb-81f8-49a3-8381-6ffc4746b474
  2 [?,?] Symbol bc646cfe-a299-4580-9a54-d8d5001a566b
"""
