...
def test_print():
    ...
    before_sampling = """\x1b[90mC GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec\x1b[0m # cond_sampler=ExactSampler, other_inputs_sampler=UncondSampler
  \x1b[90mx0_A GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec\x1b[0m # cond_sampler=ExactSampler
  \x1b[90mx0_B GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec\x1b[0m # cond_sampler=UncondSampler"""

    print(repr(C_t.print(PrintOptions(), repr=True)))
    ...
    after_sampling = """C GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec # cond_sampler=ExactSampler(d=IntDatum(xs=0, label=0)), other_inputs_sampler=UncondSampler(d=IntDatum(xs=1, label=1))
  x0_A GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec # cond_sampler=ExactSampler(d=IntDatum(xs=0, label=0))
  x0_B GeneralFunction rust_circuit.causal_scrubbing.hypothesis:InterpNodeGeneralFunctionSpec # cond_sampler=UncondSampler(d=IntDatum(xs=9, label=9))"""
