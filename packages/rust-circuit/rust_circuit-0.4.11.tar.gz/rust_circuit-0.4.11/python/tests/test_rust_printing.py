...
@st.composite
def st_maybe_many_circuits(draw: st.DrawFn, *args, **kwargs) -> Tuple[List[rc.Circuit], bool]:
...
def test_rust_printing_bijection(
    ...
    hypothesis.note(printed)
    # print_multiline_escape(printed)
    parser = rc.Parser(module_check_all_inputs_used=False)
    if is_many:
        parsed = parser.parse_circuits(printed)
    else:
        parsed = [parser.parse_circuit(printed)]
  ...
  4 Concat 0
    ...
    colorers = [
        (
            ...
            """
\x1b[32m0 Add\x1b[0m
  \x1b[36m1 [3,1] Scatter [0:2,0:1]\x1b[0m
    \x1b[32m2 [2,1] Scalar 1\x1b[0m
  \x1b[96m3 Concat 0\x1b[0m
    \x1b[33m'yoyo ' [2,3,3] Scalar 1\x1b[0m
    \x1b[31m4 'hihi' [3,3,3] Scalar 1\x1b[0m
    \x1b[36m5 'hihi' [3,3,3] Scalar 1.1\x1b[0m
    \x1b[96m6 'hihi' [3,3,3] Scalar 1.2\x1b[0m
    \x1b[96m7 'hihi' [3,3,3] Scalar 1.3\x1b[0m
    \x1b[31m8 'hihi' [3,3,3] Scalar 1.4\x1b[0m
    \x1b[32m9 'hihi' [3,3,3] Scalar 1.5\x1b[0m
    \x1b[90m10 'hihi' [3,3,3] Scalar 1.6\x1b[0m
    \x1b[34m11 'hihi' [3,3,3] Scalar 1.7\x1b[0m
    \x1b[94m12 'hihi' [3,3,3] Scalar 1.8\x1b[0m
    \x1b[96m13 'hihi' [3,3,3] Scalar 1.9\x1b[0m""".strip(
                "\n"
            ),
        ),
        (
            ...
            """
\x1b[32m0 Add\x1b[0m
  \x1b[95m1 [3,1] Scatter [0:2,0:1]\x1b[0m
    \x1b[32m2 [2,1] Scalar 1\x1b[0m
  \x1b[96m3 Concat 0\x1b[0m
    \x1b[33m'yoyo ' [2,3,3] Scalar 1\x1b[0m
    \x1b[33m4 'hihi' [3,3,3] Scalar 1\x1b[0m
    \x1b[36m5 'hihi' [3,3,3] Scalar 1.1\x1b[0m
    \x1b[35m6 'hihi' [3,3,3] Scalar 1.2\x1b[0m
    \x1b[35m7 'hihi' [3,3,3] Scalar 1.3\x1b[0m
    \x1b[33m8 'hihi' [3,3,3] Scalar 1.4\x1b[0m
    \x1b[32m9 'hihi' [3,3,3] Scalar 1.5\x1b[0m
    \x1b[90m10 'hihi' [3,3,3] Scalar 1.6\x1b[0m
    \x1b[97m11 'hihi' [3,3,3] Scalar 1.7\x1b[0m
    \x1b[94m12 'hihi' [3,3,3] Scalar 1.8\x1b[0m
    \x1b[96m13 'hihi' [3,3,3] Scalar 1.9\x1b[0m""".strip(
                "\n"
            ),
...
def test_self_hash(circ: rc.Circuit):
    try:
        replaced = circ.map_children(lambda x: rc.Scalar(1.0, x.shape, None))
        assert rc.compute_self_hash(replaced) == rc.compute_self_hash(circ)
    ...
    'bilinear_mlp.pre0' Index [0,:]
      'bilinear_mlp.fold_pre' Rearrange (a:2 b) -> a:2 b
        'bilinear_mlp.pre' Einsum i,hi->h
          'bilinear_mlp.input' [?] Symbol 873a937e-2bb9-4f7f-b55e-a100db3dde52
          'bilinear_mlp.w.proj_in' [?,?] Symbol c171d519-8793-4a8b-ac5e-d550347f30a6
    'bilinear_mlp.pre1' Index [1,:]
      'bilinear_mlp.fold_pre'
    'bilinear_mlp.w.proj_out' [?,?] Symbol e61637eb-9f17-4325-b2c2-5eb2518026cf
...
│ ├‣'bilinear_mlp.pre0' [?] Index [0,:] # h
│ │ └‣'bilinear_mlp.fold_pre' Rearrange (a:2 b) -> a:2 b
│ │   └‣'bilinear_mlp.pre' Einsum i,hi->h
│ │     ├‣'bilinear_mlp.input' [?] Symbol 873a937e-2bb9-4f7f-b55e-a100db3dde52 # i
│ │     └‣'bilinear_mlp.w.proj_in' [?,?] Symbol c171d519-8793-4a8b-ac5e-d550347f30a6 # hi
│ ├‣'bilinear_mlp.pre1' [?] Index [1,:] # h
│ │ └‣'bilinear_mlp.fold_pre'
│ └‣'bilinear_mlp.w.proj_out' [?,?] Symbol e61637eb-9f17-4325-b2c2-5eb2518026cf # oh
├‣'b.bilinear_mlp' Module ! 'bilinear_mlp.input'
│ ├‣'bilinear_mlp' # Spec
│ ├‣'b.input' [3,5,7,17] Scalar 7 ! 'bilinear_mlp.input'
│ ├‣'b.proj_in' [22,17] Scalar 8 ! 'bilinear_mlp.w.proj_in' ftt
...
'outer_b.bilinear_mlp' Module # line length: 7 # node count: 15
  'bilinear_mlp' Einsum h,h,oh->o # line length: 17 # node count: 8
    'bilinear_mlp.pre0' [?] Index [0,:] # line length: 16 # node count: 5
      'bilinear_mlp.fold_pre' Rearrange (a:2 b) -> a:2 b # line length: 27 # node count: 4
        'bilinear_mlp.pre' Einsum i,hi->h # line length: 15 # node count: 3
          'bilinear_mlp.input' [?] Symbol 873a937e-2bb9-4f7f-b55e-a100db3dde52 # line length: 48 # node count: 1
          'bilinear_mlp.w.proj_in' [?,?] Symbol c171d519-8793-4a8b-ac5e-d550347f30a6 # line length: 50 # node count: 1
    'bilinear_mlp.pre1' [?] Index [1,:] # line length: 16 # node count: 5
      'bilinear_mlp.fold_pre' # line length: 27 # node count: 4
    'bilinear_mlp.w.proj_out' [?,?] Symbol e61637eb-9f17-4325-b2c2-5eb2518026cf # line length: 50 # node count: 1
...
outer_b.bilinear_mlp Module # line length: 7 # node count: 15
  bilinear_mlp Einsum h,h,oh->o # line length: 17 # node count: 8
    ...
    bilinear_mlp.pre1 [?] Index [1,:] ... # line length: 16 # node count: 5
    bilinear_mlp.w.proj_out [?,?] Symbol e61637eb-9f17-4325-b2c2-5eb2518026cf # line length: 50 # node count: 1
  b.bilinear_mlp Module ! bilinear_mlp.input [?] Symbol 873a937e-2bb9-4f7f-b55e-a100db3dde52 # line length: 7 # node count: 12
    bilinear_mlp # line length: 17 # node count: 8
    b.input [3,5,7,17] Scalar 7 ! bilinear_mlp.input # line length: 20 # node count: 1
    b.proj_in [22,17] Scalar 8 ! bilinear_mlp.w.proj_in [?,?] Symbol c171d519-8793-4a8b-ac5e-d550347f30a6 ftt # line length: 17 # node count: 1
    b.proj_out [13,11] Scalar 9 ! bilinear_mlp.w.proj_out ftt # line length: 17 # node count: 1
  b_new.proj_in [22,13] Scalar 10 ! bilinear_mlp.w.proj_in ftt # line length: 18 # node count: 1
  b_new.proj_out [20,11] Scalar 11 ! bilinear_mlp.w.proj_out ftt # line length: 18 # node count: 1
""".strip(
...
def test_parse_ellipsis():
    x, w, b, c = rc.Parser().parse_circuits(
        """
0 Index [..., 1:]
  1 [1, 2, 3] Scalar 1.0
2 Index [:, ..., 1:]
...
4 Index [:, ..., 1:]
  1
    ...
    y = rc.Index(rc.Scalar(1.0, (1, 2, 3)), (..., slice(1, None)))
    z = rc.Index(rc.Scalar(1.0, (1, 2, 3)), (slice(None, None), slice(None, None), slice(1, None)))
    assert x == y and x == z and x == w and x == c
    b2 = rc.Index(rc.Scalar(1.0, (1, 2, 3)), (slice(1, None), ...))
    assert b == b2
