...
# body param
SchemaForRequestBodyApplicationJson = Authenticate3dsRequest


request_body_authenticate3ds_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Authenticate3dsResponse
...
class BaseApi(api_client.Api):
    ...
    def _authenticate3_ds_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_authenticate3ds_request.serialize(body, content_type)
...
class Authenticate3Ds(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def authenticate3_ds(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        header_params: RequestHeaderParams = frozendict.frozendict(),
    ...
    def authenticate3_ds(
        ...
        return self._authenticate3_ds_oapg(
            body=body,
