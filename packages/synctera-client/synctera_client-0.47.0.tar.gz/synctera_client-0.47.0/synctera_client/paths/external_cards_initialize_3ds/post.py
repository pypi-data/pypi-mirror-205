...
# body param
SchemaForRequestBodyApplicationJson = Initialize3dsRequest


request_body_initialize3ds_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Initialize3dsResponse
...
class BaseApi(api_client.Api):
    ...
    def _initialize3_ds_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_initialize3ds_request.serialize(body, content_type)
...
class Initialize3Ds(BaseApi):
    ...
    def initialize3_ds(
        ...
        return self._initialize3_ds_oapg(
            body=body,
