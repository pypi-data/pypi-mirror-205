...
# body param
SchemaForRequestBodyApplicationJson = Lookup3dsRequest


request_body_lookup3ds_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Lookup3dsResponse
...
class BaseApi(api_client.Api):
    ...
    def _lookup3_ds_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_lookup3ds_request.serialize(body, content_type)
