...
T = TypeVar("T", bound="BackgroundTaskOutCommon")


@attr.s(auto_attribs=True)
class BackgroundTaskOutCommon:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        background_task_out_common = cls(
            id=id,
            status=status,
            task=task,
        )

        background_task_out_common.additional_properties = dict_copy
        return background_task_out_common
