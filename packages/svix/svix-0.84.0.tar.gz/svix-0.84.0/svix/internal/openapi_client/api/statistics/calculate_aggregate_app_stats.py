...
from ...models.background_task_out_common import BackgroundTaskOutCommon
from ...models.calculate_app_stats_in import CalculateAppStatsIn
...
def _parse_response(*, response: httpx.Response) -> BackgroundTaskOutCommon:
    ...
    if response.status_code == 429:
        raise HttpError(response.json(), response.status_code)
    response_202 = BackgroundTaskOutCommon.from_dict(response.json())
