    ...
    return {
        ...
        "operator_pipelines": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload with no data parallelization.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with HG19 reference genome chr20 parallelized into 45 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based unmapped BAM workload with no data parallelization.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on GRCH38 primary chromosome parallelized into 23 partitions (each autosomes per partition, and chrX, chrY, and chrM merged in a single partition.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on HG19 primary chromosome parallelized into 23 partitions (each autosomes per partition, and chrX, chrY, and chrM merged in a single partition.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload with all BAM records in a single partition.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload with unmap BAM records in a single partition.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on GRCH38 primary chromosome parallelized into 3101 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on GRCH38 primary chromosome parallelized into 50 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on GRCH38 primary chromosome parallelized into 50 contiguous unmasked regions, where both pairs of a reads are presented in each partition for analyses like read consensus.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on HG19 primary chromosome parallelized into 155 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on HG19 primary chromosome parallelized into 155 contiguous unmasked regions, where both pairs of a reads are presented in each partition for analyses like read consensus.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on HG19 primary chromosome parallelized into 3109 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "File-based BAM workload parallelization pipeline with reads on HG19 primary chromosome parallelized into 77 contiguous unmasked regions.",
                "file_type": "bam",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "Automatic workload pipeline for either a shared file or a shared directory that can be shared across cluster environment.",
                "file_type": "*",
            ...
            },
            {
                ...
                "description": "File-based VCF workload parallelization pipeline with GRCh38 reference genome parallelized into 3101 contiguous unmasked regions.",
            ...
            },
            {
                ...
                "description": "File-based VCF workload loading pipeline with Glow package and Deltalake usage.",
                "file_type": "vcf,gvcf,vcf.gz,gvcf.gz",
                "workload_type": "FILE",
                "input": True,
                "operators": [
            ...
            },
            {
                ...
                "description": "Generic output operator pipeline that will upload data.",
                "file_type": "*",
                "workload_type": "DEFAULT",
                "input": False,
                "operators": [],
