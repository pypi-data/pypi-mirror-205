...
_CardCreateAliasedParamsReservedKeywords = TypedDict(
    "_CardCreateAliasedParamsReservedKeywords",
    {
        "not": str,
    },
    total=False,
...
class CardCreateAliasedParams(_CardCreateAliasedParamsReservedKeywords, total=False):
