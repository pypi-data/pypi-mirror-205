...
class FakePages(SyncAPIResource):
    def list(
        ...
        *,
    ...
    ) -> SyncFakePage[shared.SimpleObject]:
        """
        ...
        return self._get_api_list(
            "/paginated/fake_page",
            page=SyncFakePage[shared.SimpleObject],
...
class AsyncFakePages(AsyncAPIResource):
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[shared.SimpleObject, AsyncFakePage[shared.SimpleObject]]:
        """
        Endpoint that returns a top-level array that is transformed into a fake_page.
        ...
        return self._get_api_list(
            "/paginated/fake_page",
            page=AsyncFakePage[shared.SimpleObject],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
