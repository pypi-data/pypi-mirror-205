    ...
    def compile(self, input_filepath):
        with tempfile.NamedTemporaryFile() as f:
            p = subprocess.run([sys.executable, '-c',
                                f'import irisml.compiler; irisml.compiler.compiler.init(); from {input_filepath.stem} import main; irisml.compiler.compiler.generate(main, "{f.name}")'],
                               capture_output=True, cwd=input_filepath.parent)
...
def generate(main, output_filename):
