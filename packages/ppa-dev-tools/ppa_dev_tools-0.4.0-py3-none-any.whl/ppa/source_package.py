...
class SourcePackage:
    ...
    def __init__(self, pkg_dict: dict):
        """Initializes a new SourcePackage object for a given package.
    ...
    def __str__(self) -> str:
        """Human-readable textual description of the SourcePackage.
    ...
    def provides_binaries(self) -> dict[str, str]:
        """Binary package names provided by this source package.
    ...
    def build_dependencies(self) -> dict[str, str]:
        """Binary packages that must be available to build this source package.
