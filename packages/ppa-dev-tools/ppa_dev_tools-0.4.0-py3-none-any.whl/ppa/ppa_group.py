...
"""A team or person that owns one or more PPAs in Launchpad."""
...
class PpaGroup:
    ...
    def __init__(self, service, name):
        """Initializes a new PpaGroup object for a named person or team.

        :param launchpadlib.service service: The Launchpad service object.
        :param str name: Launchpad username or team name.
        """
        if not service:
