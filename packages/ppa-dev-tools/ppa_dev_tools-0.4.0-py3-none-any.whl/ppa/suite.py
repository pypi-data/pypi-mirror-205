...
class Suite:
    ...
    def __init__(self, suite_name: str, cache_dir: str):
        """Initializes a new Suite object for a given release pocket.
    ...
    def __str__(self) -> str:
        """Human-readable textual description of the Suite.
    ...
    def _rebuild_lookup_tables(self) -> bool:
        """Regenerates the provides and rdepends lookup tables.
    ...
    def components(self) -> list[str]:
        """The sections of the archive (main, universe, etc.) provided
        in this suite.
    ...
    def dependent_packages(self, source_package: SourcePackage) -> dict[str, SourcePackage]:
        """Relevant packages to run autotests against for a given source package.
