...
from docassemble_pattern.text.tree import Tree, Text, Sentence, Slice, Chunk, PNPChunk, Chink, Word, table
from docassemble_pattern.text.tree import SLASH, WORD, POS, CHUNK, PNP, REL, ANCHOR, LEMMA, AND, OR
...
class Model(object):
    ...
    def __init__(self, path="", classifier=None, known=set(), unknown=set()):
        ...
        """
        try:
            from docassemble_pattern.vector import Classifier
            from docassemble_pattern.vector import Perceptron
        except ImportError:
...
#
# from docassemble_pattern.text import Parser, commandline
...
# from docassemble_pattern.text import parse
