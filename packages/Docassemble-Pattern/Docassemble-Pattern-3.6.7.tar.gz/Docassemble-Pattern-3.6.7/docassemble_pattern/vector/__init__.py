...
try:
    from docassemble_pattern.text import singularize, predicative, conjugate, tokenize
except:
    try:
        import sys
...
from docassemble_pattern.helpers import encode_string, decode_string
...
#from docassemble_pattern.vector import stopwords
...
#   def cluster(self, method=HIERARCHICAL, k=1, iterations=1000)
    ...
    def chi_squared(self, word):
        ...
        """
        if not self._x2:
            from docassemble_pattern.metrics import chi2
            # p1: {class: count}
...
#from docassemble_pattern.vector import Vector
#
...
#from docassemble_pattern.vector import Document, KNN
#
...
#from docassemble_pattern.db import csv, pd
...
#from docassemble_pattern.vector import Perceptron, shuffled
#
#p = Perceptron()
#for i in range(5):
...
#from docassemble_pattern.db import CSV
#from docassemble_pattern.vector import SVM, chngrams, kfoldcv
#
#def v(s):
...
#from docassemble_pattern.db import CSV
#from docassemble_pattern.en import ngrams
#from docassemble_pattern.vector import Model, SVM, gridsearch
#
#def v(s):
