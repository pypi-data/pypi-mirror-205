...
class IStreamPipeline(object):
    ...
    def add_OnClosing(self, value: Callable[[], None]) -> None:
        ...
        InteropUtils.invoke("istreampipeline_add_onclosing", self._pointer, value_func_wrapper_addr)
    ...
    def remove_OnClosing(self, value: Callable[[], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in istreampipeline_remove_onclosing, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO IStreamPipeline._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in istreampipeline_remove_onclosing, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("istreampipeline_remove_onclosing", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnClosed(self, value: Callable[[], None]) -> None:
        ...
        InteropUtils.invoke("istreampipeline_add_onclosed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnClosed(self, value: Callable[[], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in istreampipeline_remove_onclosed, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO IStreamPipeline._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in istreampipeline_remove_onclosed, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("istreampipeline_remove_onclosed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
