...
class IStreamConsumer(object):
    ...
    def add_OnPackageReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("istreamconsumer_add_onpackagereceived", self._pointer, value_func_wrapper_addr)
    ...
    def remove_OnPackageReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in istreamconsumer_remove_onpackagereceived, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO IStreamConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in istreamconsumer_remove_onpackagereceived, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("istreamconsumer_remove_onpackagereceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnStreamClosed(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("istreamconsumer_add_onstreamclosed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnStreamClosed(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in istreamconsumer_remove_onstreamclosed, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO IStreamConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in istreamconsumer_remove_onstreamclosed, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("istreamconsumer_remove_onstreamclosed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
