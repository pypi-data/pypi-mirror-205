...
class ITopicConsumer(object):
    ...
    def add_OnStreamReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("itopicconsumer_add_onstreamreceived", self._pointer, value_func_wrapper_addr)
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnStreamReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_onstreamreceived, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_onstreamreceived, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_onstreamreceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnRevoking(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("itopicconsumer_add_onrevoking", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnRevoking(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_onrevoking, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_onrevoking, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_onrevoking", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnStreamsRevoked(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("itopicconsumer_add_onstreamsrevoked", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnStreamsRevoked(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_onstreamsrevoked, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_onstreamsrevoked, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_onstreamsrevoked", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnCommitted(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("itopicconsumer_add_oncommitted", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnCommitted(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_oncommitted, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_oncommitted, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_oncommitted", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnCommitting(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("itopicconsumer_add_oncommitting", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnCommitting(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_oncommitting, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_oncommitting, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_oncommitting", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnDisposed(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("itopicconsumer_add_ondisposed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnDisposed(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in itopicconsumer_remove_ondisposed, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO ITopicConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in itopicconsumer_remove_ondisposed, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("itopicconsumer_remove_ondisposed", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
