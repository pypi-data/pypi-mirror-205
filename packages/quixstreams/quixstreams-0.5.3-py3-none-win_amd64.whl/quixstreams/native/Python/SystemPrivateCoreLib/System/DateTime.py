...
class DateTime(object):
    ...
    def Deconstruct2(self, year: c_void_p, month: c_void_p, day: c_void_p) -> None:
        ...
        """
        InteropUtils.invoke("datetime_deconstruct2", self._pointer, yearOut, monthOut, dayOut)
    ...
    def TryParse5(s: str, provider: c_void_p, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("datetime_tryparse5", s_ptr, provider, resultOut)
        return result2
