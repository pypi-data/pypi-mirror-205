...
class Enum(object):
    ...
    def TryParse(enumType: c_void_p, value: str, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("enum_tryparse", enumType, value_ptr, resultOut)
        return result2
    ...
    def TryParse3(enumType: c_void_p, value: str, ignoreCase: bool, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("enum_tryparse3", enumType, value_ptr, ignoreCase_bool, resultOut)
        return result2
