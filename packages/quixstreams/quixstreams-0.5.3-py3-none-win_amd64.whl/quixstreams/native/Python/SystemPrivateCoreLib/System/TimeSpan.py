...
class TimeSpan(object):
    ...
    def TryParse3(input: str, formatProvider: c_void_p, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("timespan_tryparse3", input_ptr, formatProvider, resultOut)
        return result2
    ...
    def TryParseExact(input: str, format: str, formatProvider: c_void_p, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("timespan_tryparseexact", input_ptr, format_ptr, formatProvider, resultOut)
        return result2
    ...
    def TryParseExact3(input: str, formats: c_void_p, formatProvider: c_void_p, result: c_void_p) -> bool:
        ...
        result2 = InteropUtils.invoke("timespan_tryparseexact3", input_ptr, formats, formatProvider, resultOut)
        return result2
