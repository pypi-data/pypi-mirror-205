...
class AddEnterprizeZoneProps:
    def __init__(
        ...
        *,
        ...
        hub_vpcs: typing.Sequence[typing.Union["HubVpc", typing.Dict[str, typing.Any]]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddEnterprizeZoneProps.__init__)
...
class CentralResolverRules(
    ...
    def __init__(
        ...
        *,
        ...
        vpc: aws_cdk.aws_ec2.Vpc,
        vpc_search_tag: typing.Optional[aws_cdk.Tag] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class CentralResolverRulesProps:
    ...
    @builtins.property
    def vpc_search_tag(self) -> typing.Optional[aws_cdk.Tag]:
        '''
        :stability: experimental
        '''
...
class CrossAccountProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrossAccountProps.__init__)
...
class EnterpriseVpc(
    ...
    def add_central_resolver_rules(
        self,
        domains: typing.Sequence[builtins.str],
        search_tag: typing.Optional[aws_cdk.Tag] = None,
    ) -> None:
        '''
        :param domains: -
        :param search_tag: -
    ...
    def associate_shared_resolver_rules(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.associate_shared_resolver_rules)
            check_type(argname="argument domain_names", value=domain_names, expected_type=type_hints["domain_names"])
    ...
    def create_and_attach_r53_enterprize_zone(
        ...
        *,
        ...
        hub_vpcs: typing.Sequence[typing.Union["HubVpc", typing.Dict[str, typing.Any]]],
        is_hub_vpc: typing.Optional[builtins.bool] = None,
    ) -> aws_cdk.aws_route53.PrivateHostedZone:
        '''
        :param domainname: 
        :param hub_vpcs: 
        :param is_hub_vpc: 
        ...
        return typing.cast(aws_cdk.aws_route53.PrivateHostedZone, jsii.invoke(self, "createAndAttachR53EnterprizeZone", [props]))
    ...
    def create_and_attach_r53_private_zone(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.create_and_attach_r53_private_zone)
            check_type(argname="argument zone_name", value=zone_name, expected_type=type_hints["zone_name"])
        return typing.cast(aws_cdk.aws_route53.PrivateHostedZone, jsii.invoke(self, "createAndAttachR53PrivateZone", [zone_name]))
...
class EnterpriseZone(
    ...
    def __init__(
        ...
        *,
        ...
        hub_vpcs: typing.Optional[typing.Sequence[typing.Union["HubVpc", typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param id: -
...
class HubVpc:
    def __init__(
        ...
        *,
        region: builtins.str,
        cross_account: typing.Optional[typing.Union[CrossAccountProps, typing.Dict[str, typing.Any]]] = None,
        vpc_search_tag: typing.Optional[aws_cdk.Tag] = None,
    ) -> None:
        '''
        ...
        if __debug__:
            type_hints = typing.get_type_hints(HubVpc.__init__)
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
