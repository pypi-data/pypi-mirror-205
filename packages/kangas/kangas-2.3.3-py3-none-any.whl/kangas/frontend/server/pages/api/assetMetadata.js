...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(630970);
/* harmony import */ var _lib_formatQueryArgs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(345261);


const handler = async (req, res)=>{
    const queryString = (0,_lib_formatQueryArgs__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(req.query);
    const result = await fetch(`${_config__WEBPACK_IMPORTED_MODULE_0__/* ["default"].apiUrl */ .Z.apiUrl}asset-metadata?${queryString}`, {
        next: {
            revalidate: 10000
        }
    });
