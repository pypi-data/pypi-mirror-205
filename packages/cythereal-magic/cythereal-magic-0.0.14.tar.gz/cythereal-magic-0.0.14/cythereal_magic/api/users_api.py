...
class UsersApi(object):
    ...
    def deactivate_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['format', 'explain', 'download', 'filename', 'no_links', 'uri', 'force']  # noqa: E501
    ...
    def get_account(self, **kwargs):  # noqa: E501
        ...
        :return: EnvelopedUser200ExplainResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['format', 'explain', 'download', 'filename', 'no_links', 'uri', 'read_mask', 'expand_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EnvelopedUser200ExplainResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_my_groups(self, **kwargs):  # noqa: E501
        ...
        :param str read_mask:  Comma separated string containing a list of keys to include in the response. `*` returns all keys.  REGEX: `^(([\\w]+,?)*|\\*)$` 
        :param str expand_mask: Comma separated string containing a list of relation keys to `expand` and show the entire object inline.   REGEX: `^(([\\w]+,?)*|\\*)$`
        :return: EnvelopedGroupReducedResponseList200ExplainResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_my_groups_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EnvelopedGroupReducedResponseList200ExplainResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['first_name2', 'last_name2', 'name2', 'is_public2', 'first_name', 'last_name', 'name', 'is_public', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'format', 'explain', 'download', 'filename', 'no_links', 'uri', 'update_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
