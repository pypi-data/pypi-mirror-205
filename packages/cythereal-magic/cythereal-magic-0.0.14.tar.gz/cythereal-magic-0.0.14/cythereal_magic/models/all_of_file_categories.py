...
import six
from cythereal_magic.models.file_labels_response import FileLabelsResponse  # noqa: F401,E501

class AllOfFileCategories(FileLabelsResponse):
    ...
    if hasattr(FileLabelsResponse, "swagger_types"):
        swagger_types.update(FileLabelsResponse.swagger_types)

    attribute_map = {
    }
    if hasattr(FileLabelsResponse, "attribute_map"):
        attribute_map.update(FileLabelsResponse.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfFileCategories - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        FileLabelsResponse.__init__(self, *args, **kwargs)
