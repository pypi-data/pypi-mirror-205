...
######################################
    ...
    def get_area_prevented_USDA(self, crop: CropList, region: int, non_irrigated_only: bool = False, start_date: str = None, end_date: str = None ):
        """
        ...
        non_irrigated_data = self.get_data_points(metric_id = MetricList.AREA_PREVENTED_NON_IRRIGATED, **params)
        
        if non_irrigated_only:
            return non_irrigated_data

        irrigated_data = self.get_data_points(metric_id = MetricList.AREA_PREVENTED_IRRIGATED, **params)
        return non_irrigated_data + irrigated_data


    def get_area_prevented_GroForecasts(self, crop: CropList, region: int, start_date: str = None, end_date: str = None ):
        """
        ...
        """
        params = { "metric_id": MetricList.AREA_PREVENTED,
             "item_id": crop.value,
             "region_id": region,
             "source_id": SourceList.GRO_ENTERPRISE_MODELS,
             "frequency_id": 9,
