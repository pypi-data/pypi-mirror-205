...
from typing import Optional, Tuple, Dict, Iterator, AsyncIterator, Literal, List
...
class From_xarrayMutation(BaseModel):
    ...
    class Meta:
        document = "fragment Representation on Representation {\n  sample {\n    id\n    name\n  }\n  shape\n  id\n  store\n  variety\n  createdWhile\n  name\n  omero {\n    id\n    scale\n    physicalSize {\n      x\n      y\n      z\n      t\n      c\n    }\n    positions {\n      id\n      x\n      y\n      z\n      stage {\n        id\n      }\n    }\n    dimensionMaps {\n      id\n      dimension\n      index\n    }\n    affineTransformation\n    channels {\n      name\n      color\n    }\n  }\n  origins {\n    id\n    store\n    variety\n  }\n}\n\nmutation from_xarray($xarray: XArrayInput!, $name: String, $variety: RepresentationVarietyInput, $origins: [ID], $file_origins: [ID], $roi_origins: [ID], $tags: [String], $experiments: [ID], $datasets: [ID], $sample: ID, $omero: OmeroRepresentationInput, $views: [RepresentationViewInput], $created_while: AssignationID) {\n  fromXArray(\n    xarray: $xarray\n    name: $name\n    origins: $origins\n    tags: $tags\n    sample: $sample\n    omero: $omero\n    fileOrigins: $file_origins\n    roiOrigins: $roi_origins\n    experiments: $experiments\n    datasets: $datasets\n    variety: $variety\n    views: $views\n    createdWhile: $created_while\n  ) {\n    ...Representation\n  }\n}"
