...
T = TypeVar("T", bound="EditEgressRuleResponse")


@attr.s(auto_attribs=True)
class EditEgressRuleResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_egress_rule_response = cls(
            rule=rule,
        )

        edit_egress_rule_response.additional_properties = d
        return edit_egress_rule_response
