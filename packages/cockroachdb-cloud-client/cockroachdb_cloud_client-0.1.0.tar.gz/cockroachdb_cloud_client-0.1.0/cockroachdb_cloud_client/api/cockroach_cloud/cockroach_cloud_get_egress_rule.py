...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, GetEgressRuleResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, GetEgressRuleResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetEgressRuleResponse]
    """
