...
from ...models.cockroach_cloud_enable_datadog_metric_export_enable_datadog_metric_export_request import (
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CockroachCloudEnableDatadogMetricExportEnableDatadogMetricExportRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_id (str):
        json_body (CockroachCloudEnableDatadogMetricExportEnableDatadogMetricExportRequest):
            Example: {'api_key': 'datadog_api_key', 'site': 'US1'}.
