...
from ...models.cockroach_cloud_add_user_to_role_resource_type import CockroachCloudAddUserToRoleResourceType
from ...models.cockroach_cloud_add_user_to_role_role_name import CockroachCloudAddUserToRoleRoleName
...
def _get_kwargs(
    user_id: str,
    resource_type: CockroachCloudAddUserToRoleResourceType,
    resource_id: str,
    role_name: CockroachCloudAddUserToRoleRoleName,
    *,
    client: Client,
) -> Dict[str, Any]:
