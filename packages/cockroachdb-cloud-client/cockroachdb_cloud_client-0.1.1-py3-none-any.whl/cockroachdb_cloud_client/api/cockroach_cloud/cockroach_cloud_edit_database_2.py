...
from ...models.cockroach_cloud_edit_database_2_update_database_request import (
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CockroachCloudEditDatabase2UpdateDatabaseRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_id (str):
        json_body (CockroachCloudEditDatabase2UpdateDatabaseRequest):  Example: {'name':
