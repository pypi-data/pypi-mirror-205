...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, AwsEndpointConnections]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, AwsEndpointConnections]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, AwsEndpointConnections]
    """
