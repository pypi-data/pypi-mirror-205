...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, Invoice]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, Invoice]]:
    return Response(
