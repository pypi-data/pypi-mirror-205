...
from ...models.cockroach_cloud_list_major_cluster_versions_pagination_sort_order import (
    CockroachCloudListMajorClusterVersionsPaginationSortOrder,
)
from ...models.list_major_cluster_versions_response import ListMajorClusterVersionsResponse
...
def _get_kwargs(
    *,
    ...
    pagination_sort_order: Union[Unset, None, CockroachCloudListMajorClusterVersionsPaginationSortOrder] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v1/cluster-versions".format(client.base_url)
...
) -> Optional[Union[Any, ListMajorClusterVersionsResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListMajorClusterVersionsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, ListMajorClusterVersionsResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ListMajorClusterVersionsResponse]
    """
