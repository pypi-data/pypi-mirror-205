...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, ListClusterNodesResponse]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, ListClusterNodesResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ListClusterNodesResponse]
    """
