...
from ...models.cockroach_cloud_update_client_ca_cert_update_client_ca_cert_request import (
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CockroachCloudUpdateClientCACertUpdateClientCACertRequest,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_id (str):
        json_body (CockroachCloudUpdateClientCACertUpdateClientCACertRequest):  Example:
