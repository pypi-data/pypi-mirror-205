...
class CockroachCloudEnableCMEKSpecCMEKClusterSpecification:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cockroach_cloud_enable_cmek_spec_cmek_cluster_specification = cls(
            region_specs=region_specs,
        )

        cockroach_cloud_enable_cmek_spec_cmek_cluster_specification.additional_properties = d
        return cockroach_cloud_enable_cmek_spec_cmek_cluster_specification
