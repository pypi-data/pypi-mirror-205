...
setup(
    ...
    url='https://github.com/smjkzsl/brucelee',
    packages=['brucelee','brucelee.scripts',],
    
    include_package_data=True,
 
    entry_points={  # 指定脚本文件和其安装路径
        'console_scripts': [
            'brucelee=brucelee.scripts.main:main',
        ],
    },
    scripts=['brucelee/scripts/main.py'],  # 指定要打包进可执行文件中的脚本文件路径列表
