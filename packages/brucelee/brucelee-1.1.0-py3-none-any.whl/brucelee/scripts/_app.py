...
class HomeController(BaseController): 
    ...
    def __call__(self) -> Any:
        ...
        for name in self.args.name:
            ...
            cnt += 1
        if cnt:
            print(f"now ,you can cd to {self.args.dir}/{app_name} and run `brucelee controller controller's name` to create controllers")
...
def main():
    if not IS_IN_BRUCELEE:
        print(f"Please exec in brucelee project dir")
        exit()
