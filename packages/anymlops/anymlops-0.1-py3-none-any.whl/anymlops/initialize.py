...
from anymlops.provider import git
from anymlops.provider.cicd import github
from anymlops.provider.oauth.auth0 import create_client
from anymlops.utils import (
    check_cloud_credentials,
    namestr_regex,
    set_docker_image_tag,
    set_kubernetes_version,
    set_anymlops_dask_version,
)
...
def base_configuration():
    anymlops_image_tag = set_docker_image_tag()
    return {
        "project_name": None,
        "provider": None,
        "domain": None,
        ...
        "theme": {
            "jupyterhub": {
                ...
                "hub_subtitle": None,
                "welcome": None,
                "logo": "https://camo.githubusercontent.com/9891ae660814af838cfc216ac0a3fb42fb0c362a6fe92b99e24cb3f38a50e6d9/68747470733a2f2f6265617274656c6c2e636f6d2f696d672f416e795f706e672e706e67",
...
def default_environments():
    anymlops_dask_version = set_anymlops_dask_version()
    return {
        "environment-dask.yaml": {
            ...
            "dependencies": [
                ...
                "ipykernel=6.21.0",
                "ipywidgets==7.7.1",
                f"anymlops-dask =={anymlops_dask_version}",
...
def __getattr__(name):
    if name == "anymlops_image_tag":
        return set_docker_image_tag()
    elif name == "anymlops_dask_version":
        return set_anymlops_dask_version()
...
def render_config(
    ...
    if anymlops_domain is None and not disable_prompt:
        anymlops_domain = input("Provide domain: ")
    config["domain"] = anymlops_domain

    # In anymlops_version only use major.minor.patch version - drop any pre/post/dev suffixes
    config["anymlops_version"] = __version__
