...
def main():
    ...
    train(model, train_loader, val_loader, optimizer, criterion, device,
          num_epochs, 1, patience, batch_size, scheduler, save_path="./results/save_model/wocnn_best_model.pt")

    model.load_state_dict(torch.load("./results/save_model/wocnn_best_model.pt"))
