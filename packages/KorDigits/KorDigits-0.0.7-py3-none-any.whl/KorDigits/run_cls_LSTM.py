...
def main():
    ...
    # 데이터셋 생성
    # train_data = CLSDataset('data/cls_refine_train.txt', max_len)
    # val_data = CLSDataset('data/cls_refine_val.txt', max_len)
    # test_data = CLSDataset('data/cls_refine_test.txt', max_len)
    ...
    #       num_epochs, 1, patience, batch_size, scheduler, save_path="./results/save_model/CNN_LSTM_cls_refine_10.pt")


    model.load_state_dict(torch.load("./results/save_model/CNN_LSTM_cls_refine_10.pt"))
