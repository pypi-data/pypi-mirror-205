...
class Label2Num:
    def __init__(self):
        ...
        # self.model = AutoModel.from_pretrained('jukyung/KorDigits')

        dict_file = json.load(open('KorDigits/utils/word_dict.json', 'r', encoding='utf-8'))
        ...
        self.mecab = Mecab(dicpath=r"KorDigits/mecab-ko-dic")
