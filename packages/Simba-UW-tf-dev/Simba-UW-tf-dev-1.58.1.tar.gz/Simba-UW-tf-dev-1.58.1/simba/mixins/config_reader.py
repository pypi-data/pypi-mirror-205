...
class ConfigReader(object):
    def __init__(self,
        ...
        self.animal_cnt = self.read_config_entry(config=self.config, section=ReadConfig.GENERAL_SETTINGS.value, option=ReadConfig.ANIMAL_CNT.value, data_type=Dtypes.INT.value)
        self.clf_cnt = self.read_config_entry(self.config, ReadConfig.SML_SETTINGS.value, ReadConfig.TARGET_CNT.value, Dtypes.INT.value)
        ...
        self.pose_setting = self.read_config_entry(config=self.config, section=ReadConfig.CREATE_ENSEMBLE_SETTINGS.value, option=ReadConfig.POSE_SETTING.value, data_type=Dtypes.STR.value)
    ...
    def get_all_clf_names(self):
        ...
        for i in range(self.clf_cnt):
            ...
            model_names.append(self.read_config_entry(self.config, ReadConfig.SML_SETTINGS.value, entry_name, data_type=Dtypes.STR.value))
        return model_names
