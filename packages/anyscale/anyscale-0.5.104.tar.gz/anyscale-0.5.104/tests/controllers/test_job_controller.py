...
class TestValidateUploadPath:
    ...
    def test_validate_working_dir_and_upload_path_combinations(
        ...
        """All combinations of working_dir and upload_path should be viable
        Except for when working_dir is a remote uri and upload_path is defined
        """
        runtime_env = {}
        if working_dir:
        ...
        if "://bucket" in str(working_dir) and "://bucket" in str(upload_path):
            with pytest.raises(
...
# This also indirectly tests the websocket read
