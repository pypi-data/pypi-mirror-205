...
def test_prepare_for_managed_cloud_setup_gcp(
    ...
    mock_pool_id = f"projects/{mock_project_number}/locations/global/workloadIdentityPools/anyscale-provider-pool-{mock_token_hex}"
    ...
    if permission_denied:
        ...
        setup_utils_mock.get_workload_identity_pool.assert_called_once_with(
            factory, mock_project_id, mock_pool_id.split("/")[-1]
        )
        mock_create_cloud_api_v2_clouds_post.assert_called_once_with(
            write_cloud=WriteCloud(
                provider="GCP",
                ...
                credentials=json.dumps(
                    {
                        ...
                        "provider_id": f"{mock_pool_id}/providers/anyscale-access",
        ...
        assert chosen_pool_id == f"anyscale-provider-pool-{mock_token_hex}"
