...
the [cppipc_python]_ repository.

.. [cppipc_python] https://github.com/pybind/cppipc_python
...
PyPI integration, can be found in the [cppipc_python]_  repository.
...
can refer to the same [cppipc_python]_ repository for a full sample project
