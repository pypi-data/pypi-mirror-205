...
from classy_imaginary import config as iconfig
from classy_imaginary.config import MODEL_SHORT_NAMES
from classy_imaginary.modules import attention
from classy_imaginary.paths import PKG_ROOT
from classy_imaginary.utils import get_device, instantiate_from_config
...
def get_cache_dir():
    ...
    if xdg_cache_home is not None:
        return os.path.join(xdg_cache_home, "classy_imaginary")
