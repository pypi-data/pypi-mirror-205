...
def setup_arg_parsing():
    ...
    parser_setbaselinethreshold = subparsers.add_parser('setbaselinethreshold', parents=[env_parser], formatter_class=argparse.ArgumentDefaultsHelpFormatter, help="Clone monitoring templates")
