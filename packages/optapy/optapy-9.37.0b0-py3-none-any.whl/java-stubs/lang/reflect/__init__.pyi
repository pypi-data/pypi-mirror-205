...
class Proxy(java.io.Serializable):
    ...
    @staticmethod
    def newProxyInstance(classLoader: java.lang.ClassLoader, classArray: typing.Union[typing.List[typing.Type[typing.Any]], jpype.JArray], invocationHandler: InvocationHandler) -> typing.Any: ...
