...
class model():
    ...
    def run_inference(self,
        ...
        match engine:
            case "pyro":
                assert False, "Pyro not yet implemented"
            ...
            case "numpyro":
                ...
                print("N Samples: {}, N Warmup: {}, N Chains: {}".format(N_SAMPLES,
                                                                         N_WARMUP,
                                                                         N_CHAINS))
                nuts_kernel = numpyro.infer.NUTS(self.bayesian_model)
        ...
        match engine:
            ...
            case "numpyro":
                predictive = numpyro.infer.Predictive(self.bayesian_model, posterior_samples=mcmc.get_samples(), num_samples=N_SAMPLES,
